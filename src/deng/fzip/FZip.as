package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_494 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_96 = parseIdle;
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_142,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_142))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_142,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_95 && var_96 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_142,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_494.parse(param1))
         {
            ...
            if(false)
            {
               var_131["null"] = var_494;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1345,var_494));
            var_494 = null;
            if(var_96 != parseIdle)
            {
               var_96 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_47 != null && var_131 != null && param1 < var_47.length)
         {
