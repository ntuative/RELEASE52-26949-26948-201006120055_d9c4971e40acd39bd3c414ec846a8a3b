package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      public function method_6(param1:XML) : Boolean
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:* = null;
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(_loc4_.length() > 0)
            {
               ...
               _loc11_ = var_577.getAssetByName(_loc6_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean) : Boolean
      {
         ...
         var _loc4_:BitmapDataAsset = var_577.getAssetByName(param1) as BitmapDataAsset;
         if(_loc4_ == null)
         {
            _loc4_ = new BitmapDataAsset(var_577.getAssetTypeDeclarationByClass(BitmapDataAsset));
            var_577.setAsset(param1,_loc4_);
