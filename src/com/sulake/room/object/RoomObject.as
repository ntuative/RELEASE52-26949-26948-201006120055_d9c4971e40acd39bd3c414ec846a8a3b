package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_1503:Vector3d;
      
      private var _instanceId:int = 0;
      
      private var _id:int;
      
      private var var_1504:Vector3d;
      ...
      {
         var_1504.assign(var_235);
         return var_1504;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_490.length)
         {
            if(var_490[param2] != param1)
            {
               var_490[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_490.length)
         {
