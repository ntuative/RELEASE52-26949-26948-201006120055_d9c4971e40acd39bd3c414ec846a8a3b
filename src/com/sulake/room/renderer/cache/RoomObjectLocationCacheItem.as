package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         if(param1 != var_1189 || param2 != var_2330)
         {
            var_1189 = param1;
            var_2330 = param2;
            return true;
         ...
         if(param3)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     var_289 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     var_289.assign(_loc5_);
                  }
               }
               else
               {
            ...
            var_289.x = Math.round(var_289.x);
            var_289.y = Math.round(var_289.y);
         }
         return var_289;
      }
