package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_479:XML;
      
      protected var var_986:LoaderContext;
      
      protected var var_31:Array;
      
      protected var var_564:Array;
      
      private var var_672:uint = 0;
      
      protected var var_463:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_31 = new Array();
         var_564 = new Array();
         var_986 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_463 = new AssetLibrary("lib-" + var_672++);
         var_31.push(var_463);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_463.createAsset(param1,param2);
      }
      ...
      private function getNumAssets() : uint
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ += IAssetLibrary(var_31[_loc3_]).numAssets;
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_463.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc4_ = var_31[_loc6_];
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_564.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
            (var_31.pop() as IAssetLibrary).dispose();
         }
      }
      ...
      {
         return var_463.loadAssetFromFile(param1,param2,param3);
      }
      
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         return var_463.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetByIndex(param1:uint) : IAsset
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc2_ += IAssetLibrary(var_31[_loc5_]).numAssets;
            if(_loc2_ <= param1)
            {
               return IAssetLibrary(var_31[_loc5_]).getAssetByIndex(param1 - _loc3_);
            }
            _loc3_ = uint(_loc2_);
            _loc5_++;
         }
      ...
      {
         return var_463.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_463.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            loaderContext = var_986;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + var_672++);
         var_564.push(_loc3_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_564.length)
            {
               _loc3_ = var_564[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_564.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_463.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_463.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      private function getAssetNameArray() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ = _loc1_.concat(IAssetLibrary(var_31[_loc3_]).nameArray);
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public function getManifests() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(IAssetLibrary(var_31[_loc3_]).manifest);
            _loc3_++;
         }
         return _loc1_;
      }
