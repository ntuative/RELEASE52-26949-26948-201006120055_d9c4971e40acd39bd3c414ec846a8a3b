package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1016:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_580:uint = 0;
      
      public static const const_550:String = "AssetLibraryReady";
      
      public static const const_1367:String = "AssetLibraryUnloaded";
      
      public static const const_443:String = "AssetLibraryLoaded";
      
      public static const const_1423:String = "AssetLibraryLoadError";
       
      
      private var var_479:XML;
      ...
      private var var_399:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_580;
         var_398 = new Dictionary(false);
         var_399 = new Dictionary(false);
         var_696 = new Dictionary(false);
         var_129 = new Dictionary(false);
         var_1016.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_398)
         {
            _loc4_ = AssetTypeDeclaration(var_398[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_399)
         {
            _loc2_ = var_399[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_399[_loc1_];
         }
         ...
         var_298 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1367));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_479 = _loc2_.manifest.copy();
         var_340 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_480)
         {
            AssetLibrary.fetchLibraryContents(this,var_479,var_340);
         }
         var_298 = true;
         dispatchEvent(new Event(AssetLibrary.const_443));
         dispatchEvent(new Event(AssetLibrary.const_550));
         if(var_480)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_399[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_50,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_398.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_398[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1016.splice(var_1016.indexOf(this),1);
            --var_580;
            var_399 = null;
            var_696 = null;
            var_129 = null;
      ...
      {
         return param1 < var_339.length ? getAssetByName(var_339[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_129)
         {
            if(var_129[_loc2_] == param1)
            {
               return var_339.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_398[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_696[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_479.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_340[param1]);
      ...
      {
         var _loc2_:IAsset = var_129[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_399[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_36:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_50,e.status);
                     break;
                  }
                  if(true)
                  {
                     ++var_195;
                     var_339.push(struct.assetName);
                  }
                  var_129[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_50,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_129)
            {
               if(var_129[_loc2_] == param1)
               {
                  var_339.splice(var_339.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_398[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_340 != null ? false : false;
      }
   }
}
