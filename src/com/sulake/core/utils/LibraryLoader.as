package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1440:uint = 2;
      
      protected static const const_1441:uint = 1;
      
      public static const const_1042:int = 5;
      
      protected static const const_1151:uint = 7;
      
      protected static const const_1442:uint = 4;
      
      protected static const const_1439:uint = 3;
      ...
      protected var var_1162:Boolean = true;
      ...
      protected var var_340:Class;
      
      protected var var_2469:uint = 0;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_340 = this.getDefinition(_name) as Class;
         if(var_340 == null)
         {
         ...
         try
         {
            xmlClass = var_340.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_479 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_466 == LibraryLoader.const_1439)
         {
            if(analyzeLibrary())
            {
               var_466 |= 0;
         ...
         if(var_466 == LibraryLoader.const_1151)
         {
            var_565 = true;
            var_191 = getTimer();
            prepareLibrary();
      ...
      {
         return !!var_565 ? uint(var_191 - var_805) : uint(getTimer() - var_805);
      }
