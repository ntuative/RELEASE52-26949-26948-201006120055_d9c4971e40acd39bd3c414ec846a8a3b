package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1259:Map = new Map();
      
      private static var var_856:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_856.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_856.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_856.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_856.remove(param1);
         var_856.add(param1,param2);
      }
      
      public static function setParameter(param1:String, param2:String) : void
      {
         var_1259[param1] = param2;
      }
   }
}
