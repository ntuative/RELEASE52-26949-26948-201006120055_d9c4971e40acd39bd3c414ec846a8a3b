package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1584:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_984 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_984);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1159 & const_920)
         {
            if(_loc3_ == 0)
            {
               if(var_190.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_404 + "]";
      }
