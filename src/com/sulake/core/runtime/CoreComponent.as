package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private var var_720:IEventDispatcher;
      
      private var var_860:Profiler;
      
      private var var_266:uint;
      
      private var var_501:Array;
      
      private var var_267:LibraryLoaderQueue;
      
      private var var_606:Array;
      
      private var var_719:ProfilerViewer;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_665 = (param2 & 0) == Core.CORE_SETUP_DEBUG;
         var_501 = new Array();
         var_606 = new Array();
         var_217 = param1;
         var _loc3_:int = 0;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1302);
         if(!_isDisposed)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = var_501[_loc4_] as Array;
      ...
      {
         return var_225 - getNumberOfFilesPending();
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_720)
         {
            ...
            var_720.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
      ...
      private function debugFrameUpdateHandler(param1:Event) : void
      {
         ...
         var _loc3_:uint = _loc2_ - var_266;
         var_266 = _loc2_;
         _loc4_ = 0;
         while(_loc4_ < CoreComponent.const_144)
         {
            var_606[_loc4_] = 0;
            _loc5_ = var_501[_loc4_];
            _loc8_ = 0;
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         var_720 = loadingEventDelegate;
         if(var_267 == null)
         {
            var_267 = new LibraryLoaderQueue(var_665);
         }
         try
         {
            node = config.child(const_1116)[0];
            if(node != null)
            {
               ...
               for each(item in list)
               {
                  ...
                  loader = new ZipLoader(context,true,var_665);
         ...
         try
         {
            node = config.child(const_1117)[0];
            if(node != null)
            {
               ...
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_665);
                  assets.loadFromFile(loader,true);
                  loader.load(new URLRequest(url));
                  var_267.push(loader);
                  loader.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,updateLoadingProcess);
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_501[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      private function profilerFrameUpdateHandler(param1:Event) : void
      {
         ...
         var msSinceLastUpdate:uint = msCurrentTime - var_266;
         var_266 = msCurrentTime;
         var_860.start();
         criticality = 0;
         while(criticality < CoreComponent.const_144)
         {
            var_606[criticality] = 0;
            receivers = var_501[criticality];
            index = 0;
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_860.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_144)
            {
               _loc2_ = var_501[_loc3_] as Array;
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_720)
         {
            var_720.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_144)
         {
            ...
            {
               if(var_606[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_720)
               {
                  var_720.dispatchEvent(new LibraryProgressEvent(_loc2_.url,var_225 - 0,var_225,_loc2_.elapsedTime));
               }
            }
         }
         if(false)
