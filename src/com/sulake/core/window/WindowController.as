package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_428 = _loc13_.blend;
            var_563 = _loc13_.treshold;
            if(var_667 != _loc13_.background)
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_154);
         var _loc2_:* = !testParamFlag(WindowParam.const_130,WindowParam.const_152);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_278)
               {
      ...
      {
         if(getStateFlag(WindowState.const_93))
         {
            return true;
         }
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_829;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_667 = param1;
         var_562 = !!var_667 ? uint(var_562 | var_1444) : uint(var_562 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2062 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1176:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1416:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_684:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_705:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_971:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_765:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_883:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1035:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_445:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_748:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_983:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_294:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_503:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_253:
               _loc2_ = "null";
         }
         if(_loc2_ == WindowEvent.const_177)
         {
      ...
      public function deactivate() : Boolean
      {
         ...
         setStateFlag(WindowState.const_102,false);
         _loc1_.type = WindowNotifyEvent.const_884;
         update(this,_loc1_);
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1022;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_428 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_1020);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1085 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_316,this,param1));
         return param1;
      }
      ...
      {
         var_1444 = param1 & 4278190080;
         var_562 = !!var_667 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_80);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_657))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_942;
                  if(testParamFlag(WindowParam.const_358))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_271))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_271))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_178:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_503,this,null));
                     if(testParamFlag(WindowParam.const_185,WindowParam.const_154))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_182,WindowParam.const_152))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_253,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_458:
                  var_16.invalidate(this,var_8.union(var_57),WindowRedrawFlag.const_495);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_983,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_294,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_362:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_748,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_213,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_501:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_966);
                  break;
               case WindowNotifyEvent.const_402:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_445:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_495);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_213:
                  ...
                  break;
               case WindowNotifyEvent.const_503:
                  var_9.getRegionProperties(null,var_309);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_316:
      ...
      public function activate() : Boolean
      {
         ...
         setStateFlag(WindowState.const_102,true);
         _loc1_.type = WindowNotifyEvent.const_362;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_721,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1085 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_449)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_381)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_711,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_178,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1231,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_69,true);
         _loc1_.type = WindowNotifyEvent.const_1326;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_167 && var_563 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1569,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1569,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1306,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_69,false);
         _loc1_.type = WindowNotifyEvent.const_1305;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_309 = var_9.rectangle.clone();
               var_57.x = var_8.x;
               var_57.y = var_8.y;
               var_57.width = var_8.width;
               var_57.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_512,this,var_9));
            }
            else
            {
               var_309.x = 0;
               ...
               var_309.width = 0;
               var_309.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_851,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_445,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,_param,var_16,var_8,null,var_666,properties,var_668.concat(),_id) as WindowController;
         ...
         _loc2_.var_1444 = var_1444;
         _loc2_.var_1160 = var_1160;
         _loc2_.var_343 = var_343;
         _loc2_.var_428 = var_428;
         _loc2_._param = _param;
         _loc2_.var_37 = var_37;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_334;
         _loc2_.background = var_667;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_765;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_439;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1035;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_37 == WindowState.const_514)
         {
            return true;
         }
         var_37 = WindowState.const_514;
