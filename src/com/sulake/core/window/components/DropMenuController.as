package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_364:String = "_DROPMENU_TITLETEXT";
       
      
      private var var_132:DropMenuController;
      
      private var var_500:int = -1;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_132 = context.create(name + "::submenu","",WindowType.const_418,var_81,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_882)
         {
            if(param2 == var_132)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_400,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_337,var_81,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_500 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_500).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_604)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_499,getSubMenu(),subMenuEventProc);
                  var_604 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_500 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_344,this,null));
         }
      }
      ...
      {
         return getChildByName(DropMenuController.const_364) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_604 = false;
            getTitleText().text = var_500 < var_499.length && var_500 > -1 ? "null" : caption;
         }
      }
   }
}
