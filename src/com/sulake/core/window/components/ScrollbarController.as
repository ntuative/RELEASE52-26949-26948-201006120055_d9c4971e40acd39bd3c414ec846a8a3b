package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1070:String = "increment";
      
      private static const const_517:String = "slider_bar";
      
      private static const const_1069:String = "decrement";
      ...
      protected var var_801:Number = 0.1;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_517:
               if(param2.type == WindowNotifyEvent.const_294)
               {
                  if(!var_574)
                  {
                     if(_horizontal)
      ...
      {
         return track.findChildByName(ScrollbarController.const_517) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_815 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_815 != null)
         {
            _loc1_ = findParentByName(var_815) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_815) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1070)
            {
               if(var_21)
               {
                  var_574 = true;
            ...
            else if(param2.name == ScrollbarController.const_1069)
            {
               if(var_21)
               {
                  var_574 = true;
         ...
         if(param1.type == WindowMouseEvent.const_1045)
         {
