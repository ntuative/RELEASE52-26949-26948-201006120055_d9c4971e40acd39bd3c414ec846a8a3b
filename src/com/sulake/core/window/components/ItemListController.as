package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1053:String = "resize_on_item_update";
      
      protected static const const_1054:String = "spacing";
      
      protected static const const_1433:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1051:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1432:Boolean = true;
      ...
      protected var var_558:Boolean = false;
      
      protected var var_2422:Number = 0.0;
      
      protected var var_557:Number;
      ...
      protected var var_1440:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_167 = var_667 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_337,WindowStyle.const_312,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_273,containerEventHandler);
         _container.addEventListener(WindowEvent.const_383,containerEventHandler);
      ...
      {
         return new Rectangle(var_557 * maxScrollH,var_559 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_273,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_383,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_557 = param1;
            _container.x = -var_557 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1054,_spacing,PropertyStruct.const_67,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1052,var_802,PropertyStruct.const_63,var_802 != const_1432));
         _loc1_.push(new PropertyStruct(const_1051,var_558,PropertyStruct.const_63,var_558 != const_1433));
         _loc1_.push(new PropertyStruct(const_1053,var_1154,PropertyStruct.const_63,var_1154 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_559 = param1;
            _container.y = -var_559 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_80);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1053:
                  ...
                  break;
               case const_1052:
                  var_802 = _loc2_.value as Boolean;
                  break;
            }
         }
