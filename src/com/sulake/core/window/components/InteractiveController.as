package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1434:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_460 = new Array();
         var_460[0] = MouseCursorType.ARROW_LINK;
         var_460[1] = MouseCursorType.const_43;
         var_460[2] = MouseCursorType.ARROW_LINK;
         var_460[3] = MouseCursorType.ARROW_LINK;
         var_460[4] = MouseCursorType.const_43;
         var_460[5] = MouseCursorType.const_43;
         var_460[6] = MouseCursorType.ARROW_LINK;
         if(var_335 == null)
         {
            var_335 = new Array();
            var_335[0] = WindowState.const_102;
            var_335[1] = WindowState.const_78;
            var_335[2] = WindowState.const_82;
            var_335[3] = WindowState.const_69;
            var_335[4] = WindowState.WINDOW_STATE_SELECTED;
            var_335[5] = WindowState.const_95;
      ...
      {
         param2.push(new PropertyStruct(const_1055,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_769));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_850,param1.toolTipDelay != const_1434));
         return param2;
      }
