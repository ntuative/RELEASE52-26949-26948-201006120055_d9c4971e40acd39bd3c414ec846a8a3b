package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2425:Rectangle = new Rectangle();
       
      
      protected var var_216:Boolean;
      
      protected var var_70:TextMargins;
      
      protected var var_560:String = "none";
      
      protected var var_663:Number;
      
      protected var var_382:Number;
      
      protected var _field:TextField;
      
      protected var var_803:Boolean = false;
      ...
      {
         var_70 = new TextMargins(0,0,0,0,setTextMargins);
         var_216 = false;
         var_663 = 0;
         var_382 = 0;
         if(_field == null)
      ...
      {
         param1.var_70.dispose();
         param1.var_70 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_663 * maxScrollH,var_382 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_803)
         {
            context.removeLocalizationListener(var_334,this);
         }
         if(var_70 != null)
         {
            var_70.dispose();
      ...
      {
         var_663 = param1;
         _field.scrollH = var_663 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_334 = param1;
         if(var_334.charAt(0) == "$" && var_334.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_334.slice(2,var_334.indexOf("}")),this);
            var_803 = true;
         }
         else if(_field != null)
         {
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_70.dispose();
            var_70 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_850,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_648,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_648,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_left",var_70.left,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_top",var_70.top,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_right",var_70.right,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_70.bottom,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("auto_size",var_560,PropertyStruct.STRING,var_560 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_648,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_663 = var_663;
         _loc1_.var_382 = var_382;
         _loc1_.var_70 = var_70.clone(_loc1_.setTextMargins);
         _loc1_.var_560 = var_560;
         _loc1_.var_803 = var_803;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_560 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_560 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_560 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_560 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
