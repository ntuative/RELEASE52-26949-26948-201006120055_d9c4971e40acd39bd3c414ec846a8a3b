package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1132:String = "content";
      
      private static const const_1133:String = "selector";
       
      
      private var var_1323:Boolean = false;
      
      protected var var_988:ITabSelectorWindow;
      
      private var var_807:Boolean = false;
      
      protected var var_1673:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1673 == null)
         {
            var_1673 = findChildByTag(TabContextController.const_1132) as IWindowContainer;
         }
         return var_1673;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_988 == null)
         {
            var_988 = findChildByTag(TabContextController.const_1133) as ITabSelectorWindow;
            if(var_988 != null)
            {
               var_988.procedure = selectorEventProc;
            }
         }
         return var_988;
      }
