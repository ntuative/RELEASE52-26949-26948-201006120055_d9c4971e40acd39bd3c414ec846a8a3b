package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow
   {
      ...
      protected static const const_364:String = "_BTN_TEXT";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         switch(event.type)
         {
            ...
            case WindowNotifyEvent.const_765:
               try
               {
                  getChildByName(const_364).blend = getChildByName(const_364).blend + 0.5;
               }
               catch(e:Error)
               {
               }
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(getChildByName(const_364));
         if(_loc2_ != null)
         {
            _loc2_.text = caption;
         }
