package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_909:IItemListWindow;
      
      private var var_363:IScrollbarWindow;
      
      private var var_1589:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_76))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_363)
         {
            var_363 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_363)
            {
               var_363.addEventListener(WindowEvent.const_260,scrollBarEventProc);
               var_363.addEventListener(WindowEvent.const_222,scrollBarEventProc);
            }
         }
         return var_363;
      }
      ...
      override public function dispose() : void
      {
         if(var_363)
         {
            var_363.removeEventListener(WindowEvent.const_260,scrollBarEventProc);
            var_363.removeEventListener(WindowEvent.const_222,scrollBarEventProc);
            var_363 = null;
         }
         if(var_909)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_222)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_909)
         {
            var_909 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_909;
      }
