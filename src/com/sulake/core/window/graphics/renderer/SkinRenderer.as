package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      {
         var _loc3_:ISkinTemplate = var_331[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in var_331)
         {
            ISkinTemplate(var_331[_loc1_]).dispose();
            delete var_331[_loc1_];
         }
         var_331 = null;
         var_330 = null;
      }
