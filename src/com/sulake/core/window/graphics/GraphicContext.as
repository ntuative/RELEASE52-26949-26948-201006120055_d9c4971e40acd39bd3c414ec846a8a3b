package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_387:uint = 0;
      
      public static const GC_TYPE_TEXTFIELD:uint = 2;
      
      public static const const_1579:uint = 128;
      
      public static const const_1619:uint = 64;
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_669)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_387 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_169 = new Sprite();
            var_169.name = this.name + " - Child Container";
            var_169.mouseEnabled = false;
            addChild(var_169);
         }
         return var_169;
      }
         ...
         if(var_669)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_387 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1675,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1675,16777215);
                  }
                  var_387 += bitmap.width * bitmap.height * 4;
               }
