package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_1697:Dictionary;
      
      private var var_1455:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1455 = new Dictionary();
         var_1698 = new Dictionary();
         TypeCodeTable.fillTables(var_1455,var_1698);
         var_1170 = new Dictionary();
         var_1697 = new Dictionary();
         StateCodeTable.fillTables(var_1170,var_1697);
         var_471 = new Dictionary();
         var_471["skin"] = BitmapSkinRenderer;
         var_471["bitmap"] = BitmapDataRenderer;
         var_471["fill"] = FillSkinRenderer;
         var_471["text"] = TextSkinRenderer;
         var_471["shape"] = ShapeSkinRenderer;
         var_471["unknown"] = SkinRenderer;
         var_471["null"] = NullSkinRenderer;
         if(var_386 == null)
         {
            var_386 = new Array();
            var_386.push(WindowState.const_69);
            var_386.push(WindowState.const_76);
            var_386.push(WindowState.const_95);
            var_386.push(WindowState.WINDOW_STATE_SELECTED);
            var_386.push(WindowState.const_82);
            var_386.push(WindowState.const_78);
            var_386.push(WindowState.const_102);
            var_386.push(WindowState.const_93);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1170)
         {
            _loc3_.push(var_1170[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1455[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_675[param1];
      ...
      {
         var _loc3_:Array = var_676[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_676[param1] = new Array(SkinContainer.const_771);
         }
         var_676[param1][param2] = param3;
         if(true)
         {
            var_675[param1] = new Array(SkinContainer.const_771);
         }
         var_675[param1][param2] = param4;
      }
