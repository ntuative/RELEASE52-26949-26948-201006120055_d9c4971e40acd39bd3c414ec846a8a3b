package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1545:String = "_INCLUDE";
      
      public static const const_993:String = "_EXCLUDE";
      
      public static const const_1566:String = "_TEMP";
      
      private static const const_1167:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1168:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1163:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_994:Dictionary;
      
      protected var var_1446:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1447:Dictionary;
      
      protected var var_1164:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1163 = new Dictionary();
         TypeCodeTable.fillTables(var_1164,var_1163);
         var_994 = new Dictionary();
         var_1447 = new Dictionary();
         ParamCodeTable.fillTables(var_994,var_1447);
         var_1446 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1168,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1164)
            {
               delete var_1164[_loc1_];
            }
            for(_loc1_ in var_1163)
            {
               delete var_1163[_loc1_];
            }
            for(_loc1_ in var_994)
            {
               delete var_994[_loc1_];
            }
            for(_loc1_ in var_1447)
            {
               delete var_1447[_loc1_];
            }
            var_1446.dispose();
            var_1446 = null;
            var_16 = null;
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_182)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_993) == -1)
                  {
