package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_451:int = 2.147483647E9;
      ...
      {
         return var_452 == int.MIN_VALUE && var_451 == int.MAX_VALUE && var_449 == int.MIN_VALUE && var_450 == int.MAX_VALUE;
      }
      ...
      {
         var_450 = param1;
         if(var_450 < int.MAX_VALUE && true && _target.height > var_450)
         {
            _target.height = var_450;
         }
      }
      ...
      {
         var_452 = param1;
         if(var_452 > int.MIN_VALUE && true && _target.width < var_452)
         {
            _target.width = var_452;
         }
      }
