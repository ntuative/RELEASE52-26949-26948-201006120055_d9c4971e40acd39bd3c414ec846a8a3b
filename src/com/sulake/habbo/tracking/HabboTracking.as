package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_819:uint = 11;
      
      private static var _instance:HabboTracking;
       
      
      private var var_246:LatencyTracker = null;
      
      private var var_245:PerformanceTracker = null;
      
      private var var_546:FramerateTracker = null;
      ...
      private var var_154:IHabboHelp;
      
      private var var_1135:int = -1;
      
      private var var_954:LagWarningLogger = null;
      
      private var var_955:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_245 = new PerformanceTracker();
         var_546 = new FramerateTracker();
         var_246 = new LatencyTracker();
         var_954 = new LagWarningLogger();
         var_1419 = new Array(const_819);
         var _loc4_:int = 0;
         while(_loc4_ < const_819)
         {
            var_1419[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1308,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1391,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_563,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1046,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_556:
               trackLoginStep(HabboLoginTrackingStep.const_1426,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_189:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_189);
               break;
            case HabboCommunicationEvent.const_242:
               setErrorContextFlag(3,0);
               trackLoginStep(HabboLoginTrackingStep.const_242);
               if(var_246 != null)
               {
                  var_246.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_245 != null)
            {
               var_245.connection = param1;
            }
            if(var_246 != null)
            {
               var_246.communication = _communication;
               var_246.connection = param1;
            }
            if(var_954 != null)
            {
               var_954.connection = param1;
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_146)
         {
            Component(var_146).events.addEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
            if(var_246 != null)
            {
               var_246.configuration = var_146;
            }
            if(var_245 != null)
            {
               var_245.configuration = var_146;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_273.events.addEventListener(AdEvent.const_405,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2286)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1402);
            var_2286 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1046,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_563,String(true));
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_315:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_955)
            {
               var_955.release(new IIDHabboWindowManager());
               var_955 = null;
            }
            if(var_273)
            {
            ...
            if(var_186)
            {
               if(true)
               {
                  ...
                  Component(var_186).events.removeEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
               }
            ...
            if(var_154)
            {
               if(true)
               {
                  var_154.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_154.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_154.release(new IIDHabboHelp());
               var_154 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_435,onLagWarningEvent);
               }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_189,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_171,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_242,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_557,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_68,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_463,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_435:
               var_954.warpingDetected();
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_146)
         {
            if(var_954 != null)
            {
               var_954.configure(var_146);
            }
            if(var_546 != null)
            {
               var_546.configure(var_146);
            }
            Component(var_146).events.removeEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
         }
      }
      ...
      {
         var_154 = param2 as IHabboHelp;
         var_154.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_154.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         var_955 = IHabboWindowManager(param2);
         if(var_955)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1135 > -1 && _loc2_ < var_1135)
         {
            ++var_1648;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1648);
         }
         if(var_1135 > -1 && _loc2_ - var_1135 > 15000)
         {
            ++var_1649;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1649);
         }
         var_1135 = _loc2_;
         if(var_245 != null)
         {
            var_245.update(param1);
         }
         if(var_246 != null)
         {
            var_246.update(param1);
         }
         if(var_546 != null)
         {
            var_546.trackUpdate(param1,this);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_435,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_298,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_186).events.addEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_146)
            {
               if(var_146.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_245 != null)
                  {
                     _loc4_["null"] = var_245.flashVersion;
                     _loc4_["null"] = var_245.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_557)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1240);
         }
         else if(param1.type == HabboHotelViewEvent.const_463)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1173);
         }
