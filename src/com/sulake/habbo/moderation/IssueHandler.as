package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_437:UserInfoCtrl;
      
      private var var_60:ModerationManager;
      
      private var var_1101:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.releaseBundle(var_117.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc1_:XmlAsset = var_60.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         _window = var_60.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(_window == null)
         {
            return;
         }
         ...
         var_60.disableButton(var_60.initMsg.chatlogsPermission,_window,"show_chatlog");
         ...
         var_437 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_1101 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_437.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_117.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1101.load(_loc4_,var_117.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_117.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = var_60.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = var_60.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_60,WindowTracker.const_988,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_60 != null && false && var_117 != null)
         {
            var_60.issueManager.removeHandler(var_117.id);
         }
         this.dispose();
      }
      ...
      {
         if(_window == null || var_60 == null || true)
         {
            return;
         }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_437 = new UserInfoCtrl(_window,var_60,_loc3_.message);
            var_437.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_117.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_117.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = var_60.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = var_60.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
