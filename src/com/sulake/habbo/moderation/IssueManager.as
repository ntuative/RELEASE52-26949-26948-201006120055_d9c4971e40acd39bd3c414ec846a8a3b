package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1036:String = "issue_bundle_open";
      
      public static const const_672:String = "issue_bundle_my";
      
      public static const const_1010:String = "issue_bundle_picked";
       
      
      private var var_773:Array;
      
      private var var_936:Map;
      ...
      private var var_645:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_144 = new Map();
         var_936 = new Map();
         var_645 = new IssueBrowser(this,var_60.windowManager,var_60.assets);
         var_773 = [];
         var_935 = [];
         var_1118 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1118.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:IssueBundle = var_144.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_773 = var_773.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_936.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_144.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_144.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_936.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1223)
         {
            var_160.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_144)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_936.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_936.add(param1.issueId,_loc2_);
            var_144.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_773.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_157)
         {
            _loc5_ = getBundles(const_672);
            _loc6_ = false;
            ...
            _loc8_ = var_935.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1118.remove(param1);
         var_1118.add(param1,_loc3_);
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_935 = var_935.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_144.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_1118.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_144.getValues();
         for each(_loc3_ in _loc1_)
         {
            if(_loc3_.state == IssueMessageData.const_157 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_645 == null || !var_645.isOpen())
         {
            var_60.soundManager.playSound(HabboSoundTypesEnum.const_952);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_936.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_144.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_144.getValues();
