package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2447:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_50 = param3;
         var_1271 = param4;
         var_1490 = var_645.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1490 == null)
            {
               return;
            }
            _loc2_ = var_1490.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_645.assets.getAssetByName(_loc8_) as BitmapDataAsset;
