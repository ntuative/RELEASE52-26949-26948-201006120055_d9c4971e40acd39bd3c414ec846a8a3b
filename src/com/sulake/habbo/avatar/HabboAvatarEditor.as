package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1075:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1074:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_831:AvatarEditorHandler;
      ...
      private const const_1076:int = 2;
      ...
      private var var_1027:IHabboAvatarEditorDataSaver = null;
      ...
      private function init() : void
      {
         ...
         if(!var_168)
         {
            ...
            _loc1_ = var_484["null"];
            _loc2_ = var_484["null"];
            _loc1_.loadAvatarData(const_1075,FigureData.const_77);
            _loc2_.loadAvatarData(const_1074,FigureData.const_73);
            var_93 = new Map();
            var_403 = new Map();
            var_93.add(AvatarEditorFigureCategory.const_548,new BodyModel(this));
            var_93.add(AvatarEditorFigureCategory.const_46,new HeadModel(this));
            var_93.add(AvatarEditorFigureCategory.const_226,new TorsoModel(this));
            var_93.add(AvatarEditorFigureCategory.const_615,new LegsModel(this));
            var_93.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_403.add(AvatarEditorSideCategory.const_100,new WardrobeModel(this));
            var_403.add(AvatarEditorSideCategory.const_457,new ClubPromoModel(this));
            var_168 = true;
         }
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1027 != null)
         {
            ...
            _loc2_ = "null";
            var_1027.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1028 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1486;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1028 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1076)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1669.clone() as IWindowContainer,param1,_loc14_);
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1433.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1028 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1433.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_403.getValue(AvatarEditorSideCategory.const_100);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_831 = new AvatarEditorHandler(this,_communication);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_403.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_219 == null)
            {
               var_219 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_219.addChild(_view.window);
               var_219.center();
               var_219.visible = false;
            }
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_548);
         }
         var_1027 = param2;
         return true;
      }
      ...
      {
         var_702 = var_583.getFigureData(AvatarType.const_98);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_583 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
