package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_483:String = "fx";
      ...
      private var var_1543:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_1984 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1296 = parseInt(param2.@dy);
         var_1295 = parseInt(param2.@dz);
         ...
         if(param5 != null)
         {
            var_1543 = new ActiveActionData(param5.state,_loc7_);
            var_1543.definition = param5;
         }
      }
