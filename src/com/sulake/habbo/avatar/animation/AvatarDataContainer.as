package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1601:Number = 1.0;
      ...
      private var var_1801:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1600,var_1601,var_1599,_alphaMultiplier);
         var_1026 = generatePaletteMapForGrayscale(var_1799,var_1800);
      }
      
      public function get reds() : Array
      {
         return var_1026.getValue("reds") as Array;
      }
      ...
      {
         return var_1026.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1026.getValue("greens") as Array;
      }
      ...
      {
         return var_1026.getValue("alphas") as Array;
      }
