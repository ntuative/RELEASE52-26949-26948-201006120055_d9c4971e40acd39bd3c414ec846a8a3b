package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_393:PartSetsData;
      
      private var var_1462:PartOffsetData;
      
      private var var_812:AvatarActionManager;
      
      private var var_171:IAssetLibrary;
      
      private var var_813:IAssetLibrary;
      
      private var var_1717:AvatarRenderManager;
      
      private var var_297:FigureData;
      
      private var var_592:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_684:String;
      
      private var var_1461:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_171 = param2;
         var_813 = param3;
         var_297 = new FigureData();
         var_393 = new PartSetsData();
         var_592 = new AnimationData();
         var_1461 = new AvatarStructureDownloadSet();
         var_685 = new AnimationManager();
         var_684 = param4;
         var_1462 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_812.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_812.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_297.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_812.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_393.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_393.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1388[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_812.getDefaultAction();
         var _loc9_:Array = var_393.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_685.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_297.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_297.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_592.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_393.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_393.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         if(var_684 == AvatarType.const_98)
         {
            var_393.getPartDefinition("ri").appendToFigure = true;
            var_393.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_684)
         {
            case AvatarType.const_98:
               ...
               var_1461.add(new AvatarStructureDownload(var_171,_loc5_,var_297));
               break;
            case AvatarType.PET:
         }
         var_1461.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_812 = new AvatarActionManager(var_171,var_684);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1186 = var_297.getMandatorySetTypeIds();
         return var_1186;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_297.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_813.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_813.getAssetByName("dance" + _loc1_).content as XML;
            var_685.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_813.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_813.getAssetByName("fx" + _loc1_).content as XML;
            var_685.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_1462.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_297.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_297.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1462.loadOffsets(var_813);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_812.sortActions(param1);
      }
   }
}
