package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_691:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1010:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_691 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1010 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_691)
         {
            var_691.removeListItems();
         }
         if(var_1010)
         {
            var_1010.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_691)
               {
                  var_691.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1010)
            {
               var_1010.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
