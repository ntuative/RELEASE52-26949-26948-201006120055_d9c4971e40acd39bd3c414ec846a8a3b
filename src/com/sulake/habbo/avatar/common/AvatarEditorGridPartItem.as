package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1713:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private const const_1714:int = 13421772;
      ...
      private var var_385:BitmapData;
      
      private var _model:IAvatarEditorCategoryModel;
      
      private var var_639:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_385 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               var_1609 = Math.max(var_1609,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(isSelected)
         {
            _window.color = const_1714;
         }
         else
         {
            _window.color = const_1713;
         }
         _window.invalidate();
      }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc1_ in partSet.parts)
         {
            if(_loc6_)
            {
               _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + const_250[_loc5_] + "_" + FigureData.const_115;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         for each(_loc2_ in _loc8_)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + const_250[_loc6_] + "_" + FigureData.const_115;
            ...
            if(_loc4_)
            {
               ...
               if(var_1608 && _loc2_.colorLayerIndex > 0)
               {
