package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_791:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_709.width,var_709.height,true,0);
            _loc1_.bitmap.copyPixels(var_709,var_709.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_951.width,var_951.height,true,0);
            _loc5_ = var_951.clone();
            _loc5_.colorTransform(_loc5_.rect,var_791.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_792.width,var_792.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_792,var_792.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
