package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_35:Dictionary;
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2339);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_35[var_152];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function showPalettes(param1:String, param2:int) : void
      {
         ...
         var _loc3_:AvatarEditorGridView = var_35[param1] as AvatarEditorGridView;
         if(!_loc3_)
         {
            return;
         }
