package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1454:int = 60000;
      ...
      private var var_824:IAvatarImage;
      ...
      {
         if(var_613 == param1 || var_613 == GeometryType.const_1007 && param1 == GeometryType.const_1002 || param1 == GeometryType.const_1007 && var_613 == GeometryType.const_1002)
         {
            var_613 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_692)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_483)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_80.getParts(param1,var_824.getFigure(),_loc6_,var_613,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_148,var_613);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            _loc9_ = var_148 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_148 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_900 || _loc30_ == AvatarAction.const_404) && (_loc6_ == AvatarBodyPartType.const_226 || _loc6_ == AvatarBodyPartType.const_1201 || _loc6_ == AvatarBodyPartType.const_1296) && _loc7_.color != null)
               {
               ...
               if(_loc22_)
               {
                  if(var_148 == AvatarScaleType.const_56)
                  {
                     _loc31_.x += 65;
                  }
                  else
               ...
               _loc32_ = new ImageData(_loc8_,_loc31_,_loc22_,false);
         ...
         var _loc26_:Point = new Point(-_loc25_.regpoint.x,_loc21_.y - _loc25_.regpoint.y);
         if(_loc17_)
         {
            if(var_148 == AvatarScaleType.const_56)
            {
