package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_629];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_629:
      ...
      {
         return [RoomSessionDoorbellEvent.const_113,RoomSessionDoorbellEvent.const_122,RoomSessionDoorbellEvent.const_58];
      }
