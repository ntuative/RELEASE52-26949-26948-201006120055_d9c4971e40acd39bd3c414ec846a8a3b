package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1121:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      
      private static const const_1122:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_553,RoomWidgetClothingChangeMessage.const_340,RoomWidgetAvatarEditorMessage.const_308];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_553:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_361,_loc6_.id,_loc6_.category,_loc6_.roomId,_loc6_.roomCategory);
            ...
            case RoomWidgetClothingChangeMessage.const_340:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc7_.gender == FigureData.const_73)
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_939);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1121;
                        }
                     }
                     if(_container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_226,AvatarEditorFigureCategory.const_615],true))
                     {
                        _loc11_ = 0;
                        ...
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_361,_loc7_.objectId,_loc7_.objectCategory,_loc7_.roomId,_loc7_.roomCategory);
                        _container.events.dispatchEvent(_loc5_);
                     }
                  }
               }
