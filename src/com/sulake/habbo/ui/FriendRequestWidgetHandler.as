package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_723);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_729);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_701);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_137:
            ...
            case FriendRequestEvent.const_282:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_723:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_40,_container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_729:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_701:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_137);
         _loc1_.push(FriendRequestEvent.const_58);
         _loc1_.push(FriendRequestEvent.const_282);
         return _loc1_;
      }
