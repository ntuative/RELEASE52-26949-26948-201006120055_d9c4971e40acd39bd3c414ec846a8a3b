package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_877:Number = 0.0;
      
      private var var_504:Point = null;
      
      private var var_732:Map = null;
      
      private var var_505:Vector3d;
      ...
      {
         return [RoomSessionChatEvent.const_155];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_350 != null)
         {
            ...
            {
               _loc2_ = var_350.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_155:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_350.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_732.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_356:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_350.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_732.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_566,RoomWidgetChatSelectAvatarMessage.const_633];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_566:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_155,_container.roomSession,0,"Version 26949-26948-201006120043");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_633:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_877 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_877);
            }
            if(var_504 == null)
            {
               var_505.x = 0;
               var_505.y = 0;
               var_505.z = 0;
               var_504 = _loc4_.getScreenPoint(var_505);
               var_877 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_505.x = 0;
            var_505.y = 0;
            var_505.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_505);
            if(_loc8_ != null)
            {
