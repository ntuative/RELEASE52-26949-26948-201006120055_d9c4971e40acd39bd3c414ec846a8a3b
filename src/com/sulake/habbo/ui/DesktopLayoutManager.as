package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1735:String = "room_widget";
      
      private const const_1165:String = "room_view";
      
      private var var_56:IWindowContainer;
      
      private var var_793:int = 50;
      
      private var var_2413:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_56.getChildByTag(const_1165) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_56.findChildByTag(const_1165) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
         ...
         _loc2_.offset(var_56.x,var_56.y);
         return _loc2_;
      }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_793;
               _loc2_.width = var_56.desktop.width - var_793;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_793;
               _loc2_.height = var_56.desktop.height - var_793;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_56.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_56.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_273,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1735) == 0)
            {
