   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1011,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_753,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_496,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_114,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_753,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1027,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_908,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_496,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_114,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_114:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_114));
               break;
            case HabboHelpTutorialEvent.const_496:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_511));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_747);
         _loc1_.push(RoomWidgetDanceMessage.const_725);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_564);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_730);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_568);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_598);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_739);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_675);
         _loc1_.push(RoomWidgetStopEffectMessage.const_715);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1224);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_929);
         _loc1_.push(RoomWidgetToolbarMessage.const_639);
         _loc1_.push(RoomWidgetToolbarMessage.const_543);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_308);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1344);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_889);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_703);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_603);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_686);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1289);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_709);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_551);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_740);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_571));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_603:
               ...
               break;
            case RoomWidgetWaveMessage.const_747:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_564:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_730:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_568:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_675:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_826)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_215,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_739:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_905:
                        _catalog.openCatalogPage(CatalogPageName.const_1205,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1006:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1317:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1216:
                        break;
                     default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_929:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_703:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_639:
               ...
               break;
            case RoomWidgetToolbarMessage.const_543:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_424,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_308:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_490));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_686:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_334,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_709:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_334,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_551:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_334,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_740:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_434));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_340:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_606));
               break;
            default:
