package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_140,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_158,onFigureUpdate);
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_140,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_158,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_621);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_893);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_898);
            ...
            case RoomObjectCategoryEnum.const_40:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_347)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_945)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_403);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_221)
               {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_854;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1339);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_629.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_629.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_766);
         _loc1_.push(RoomWidgetFurniActionMessage.const_752);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_757);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1184);
         _loc1_.push(RoomWidgetPetCommandMessage.const_570);
         _loc1_.push(RoomWidgetPetCommandMessage.const_653);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_741:
               _container.friendList.method_9(_loc2_,_loc3_.name);
               break;
            ...
            case RoomWidgetUserActionMessage.const_607:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1008,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_704:
               _container.roomSession.method_8(_loc3_.webID);
               break;
            ...
            case RoomWidgetUserActionMessage.const_574:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_766:
            ...
            case RoomWidgetUserActionMessage.const_421:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_757:
