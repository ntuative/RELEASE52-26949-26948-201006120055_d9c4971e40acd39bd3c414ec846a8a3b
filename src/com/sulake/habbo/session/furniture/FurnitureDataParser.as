package com.sulake.habbo.session.furniture
{
   ...
   public class FurnitureDataParser extends EventDispatcher
   {
      ...
      public static const const_106:String = "ready";
      ...
      private var var_690:AssetLibrary;
      ...
      public function FurnitureDataParser(param1:String, param2:Map, param3:Map, param4:Map, param5:ICoreLocalizationManager)
      {
         ...
         var_690 = new AssetLibrary("FurniDataParserAssetLib");
         var _loc6_:AssetLoaderStruct = var_690.loadAssetFromFile(param1,new URLRequest(param1),"text/plain");
         _loc6_.addEventListener(AssetLoaderEvent.const_36,parseFurnitureData);
      }
      ...
      private function parseFurnitureData(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc10_ in _loc8_)
         {
            ...
            for each(_loc12_ in _loc11_)
            {
               ...
               if(_loc14_ == "s")
               {
                  var_456.add(_loc15_,_loc29_);
               }
               else if(_loc14_ == "i")
               {
                  _wallItems.add(_loc15_,_loc29_);
               }
               var_1363.add(_loc17_,_loc15_);
            }
            _loc9_++;
         }
         dispatchEvent(new Event(const_106));
      }
