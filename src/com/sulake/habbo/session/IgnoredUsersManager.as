package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      public function ignoreUser(param1:String) : void
      {
         ...
         var _loc2_:IConnection = var_30.communication.getHabboMainConnection(null);
         _loc2_.send(new IgnoreUserMessageComposer(param1));
      }
      
      public function initIgnoreList() : void
      {
         var _loc1_:IConnection = var_30.communication.getHabboMainConnection(null);
         _loc1_.send(new GetIgnoredUsersMessageComposer(var_30.userName));
      }
      ...
      private function onIgnoreResult(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = String(var_1187.shift());
