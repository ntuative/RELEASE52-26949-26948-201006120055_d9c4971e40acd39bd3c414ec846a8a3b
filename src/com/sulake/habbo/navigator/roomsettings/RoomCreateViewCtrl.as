package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_485 = new Timer(100);
         var_485.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,80,"g"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,74,"h"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,416,"o"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,352,"p"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,304,"q"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,336,"r"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,748,"u"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,438,"v"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_53,540,"t"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_53,512,"w"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_53,396,"x"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_53,440,"y"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_53,456,"z"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_53,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1035 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_485)
         {
            var_485.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_485.reset();
            var_485 = null;
         }
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_71,new Rectangle(0,0,100,300)));
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1223 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1223 = true;
            _loc3_.y = 1;
