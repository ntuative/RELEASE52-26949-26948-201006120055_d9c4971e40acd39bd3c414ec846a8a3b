package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1827:IWindowContainer;
      ...
      {
         setEnabled(_bgTabButton,this._model.mode != ThumbnailEditorModel.const_42);
         setEnabled(var_1495,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1494,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_42;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1495 = IButtonWindow(find("top_tab"));
         var_1494 = IButtonWindow(find("obj_tab"));
         var_1828 = IWindowContainer(find("tile_grid"));
         var_1827 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1495,onTopTabButton);
         Util.setProcDirectly(var_1494,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1828;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_466)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1827;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_71,new Rectangle(0,0,param1.width,66)));
      ...
      {
         refreshImgSelector(ThumbnailEditorModel.const_42);
