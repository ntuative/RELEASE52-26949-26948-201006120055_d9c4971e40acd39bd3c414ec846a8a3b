package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1110:int = -16;
      
      private static const const_787:int = 32;
      
      private static const const_1109:int = 8;
      
      public static const const_466:int = 10;
      
      private static const const_1108:int = 40;
      ...
      private var var_1915:Dictionary;
      
      private var var_858:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_858 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_858.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1110,_loc4_.y + const_1108 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1915[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_858.getImage(ThumbnailEditorModel.const_42,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_858.getImage(ThumbnailEditorModel.const_42,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_858.getImage(ThumbnailEditorModel.const_57,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_787 + _loc3_,param2 * const_1109);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_466)
         {
            var_1052[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1052[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_466)
         {
            if(false)
            {
               refreshObj(param1,var_1052[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1261 == null)
         {
            var_1261 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1261,var_1261.rect,new Point(0,0),null,null,true);
      }
   }
}
