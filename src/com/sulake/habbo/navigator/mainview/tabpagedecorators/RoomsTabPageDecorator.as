package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_259,Tabs.const_330);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_259,Tabs.const_659);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_259,Tabs.const_330,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_498 == null)
         {
            var_498 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_498.procedure = onChangeFilter;
