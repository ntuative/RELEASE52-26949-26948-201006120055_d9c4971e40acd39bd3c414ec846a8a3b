package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_506:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 4)
         {
            return Tabs.const_698;
         }
         return Tabs.const_240;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_506 == null ? 0 : int(var_506.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_296,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_506 == null)
         {
            var_506 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_506.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
