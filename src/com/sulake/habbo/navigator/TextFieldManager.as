package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         var_72.addEventListener(WindowKeyboardEvent.const_150,checkEnterPress);
         var_72.addEventListener(WindowEvent.const_123,checkMaxLen);
         this.var_2370 = var_72.textBackground;
         this._orgTextBackgroundColor = var_72.textBackgroundColor;
         this.var_2369 = var_72.textColor;
      }
      ...
      {
         var_72.textBackground = this.var_2370;
         var_72.textBackgroundColor = this._orgTextBackgroundColor;
         var_72.textColor = this.var_2369;
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > var_1509)
         {
            var_72.text = _loc2_.substring(0,var_1509);
         }
      }
   }
}
