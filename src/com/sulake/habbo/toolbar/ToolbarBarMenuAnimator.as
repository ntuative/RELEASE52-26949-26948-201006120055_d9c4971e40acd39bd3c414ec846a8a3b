package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1125:Number = 90;
      
      private static const const_825:int = 50;
      
      private static const const_1124:Number = 25;
      
      private static const const_1171:int = 50;
      ...
      private var var_1150:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1150 = param2;
         var_659 = new Timer(const_1124);
         var_659.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_555.push(param1.name);
         var_556.push(param2);
         param1.addEventListener(WindowEvent.const_480,windowEventListener);
         param1.addEventListener(WindowEvent.const_222,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_556[var_555.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1150.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_329.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_329.splice(var_329.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1150.getIconLoc(param1.iconId);
      ...
      {
         return var_555[var_556.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_329[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_658[_loc3_] = new Array();
            }
            if(var_658[_loc3_].indexOf(param1) < 0)
            {
               var_658[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_825 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_825 || param1.desktop.height - param1.y < const_1171;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_555[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_658[_loc3_].length)
                  {
                     repositionWindow(var_658[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
