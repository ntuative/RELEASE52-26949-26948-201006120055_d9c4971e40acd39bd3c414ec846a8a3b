package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_328.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_132,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1011,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_174,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_195,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_52,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_424,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_673,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_944,onHideWindowEvent);
         var_37 = true;
