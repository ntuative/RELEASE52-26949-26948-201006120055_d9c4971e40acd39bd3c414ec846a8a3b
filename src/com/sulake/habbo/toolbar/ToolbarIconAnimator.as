package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_868:BitmapData;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1282 = param1.loop;
         if(param1.background != null)
         {
            var_868 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_867.push(new XML());
               var_869.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_869[var_52] = param6.clone();
         }
      ...
      {
         if(var_1282 == true || var_727 == 0)
         {
            if(false)
            {
               ++var_52;
               if(var_52 >= var_867.length)
               {
                  var_52 = 0;
                  ++var_727;
               }
      ...
      {
         return var_867.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1282 == false && var_727 == 1 && var_1226 != var_37;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_868 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_868.width),Math.max(param2.height,var_868.height));
            _loc3_.copyPixels(var_868,var_868.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_52 <= var_869.length)
         {
            _loc2_ = var_869[var_52];
