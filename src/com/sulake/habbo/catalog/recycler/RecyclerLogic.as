package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_813:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1642)
         {
            case RecyclerStatusMessageEvent.const_1347:
               var_285 = const_375;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_969:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1331:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1642 != RecyclerStatusMessageEvent.const_969;
      }
      
      private function get statusActive() : Boolean
      {
         return var_285 != const_814;
      }
      ...
      {
         return active && var_285 == const_375;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_977:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1251:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!_catalog.returnInventoryFurniFromRecycler(var_102[param1].id))
         {
            return;
         }
         var_102[param1] = null;
