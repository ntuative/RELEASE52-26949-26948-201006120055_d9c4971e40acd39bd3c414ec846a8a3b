package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1458:uint = 4.294967295E9;
      
      private const const_1459:uint = 4.293848814E9;
      
      private var var_891:int;
      
      private const const_1721:uint = 4.291613146E9;
      ...
      private const const_1720:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_892;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_892,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1459) : uint(const_1458);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_443,var_78,var_1076);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_271) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_892);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_617[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_616[var_204]);
         _catalog.purchaseProductAsGift(var_443,var_78,var_1076,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_123:
               ...
               if(var_2040 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_243)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1720)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2040 = _loc3_.text;
               break;
            case WindowMouseEvent.const_55:
               showSuggestions(false);
               if(var_1318)
               ...
               break;
            case WindowKeyboardEvent.const_760:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_271 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_271 + 1);
                     break;
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_271) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_271);
         }
         var_271 = param1;
         if(var_271 < 0)
         {
            var_271 = _loc2_.numListItems - 1;
         }
         if(var_271 >= _loc2_.numListItems)
         {
            var_271 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_271) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_512 == null)
         {
            var_512 = createWindow("suggestion_list_item") as IWindowContainer;
            var_512.procedure = suggestionsEventHandler;
         }
         if(var_231 == null || var_512 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_231.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_512.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
