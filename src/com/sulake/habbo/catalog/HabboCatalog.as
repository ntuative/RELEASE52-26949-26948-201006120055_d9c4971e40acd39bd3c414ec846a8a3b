package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_389:ClubBuyController;
      ...
      private var var_388:ICatalogNavigator;
      ...
      private var var_1688:GiftWrappingConfiguration;
      ...
      private var var_997:ClubGiftController;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1689 && var_470 != null)
         {
            var_470.playSound(HabboSoundTypesEnum.const_951);
         }
         var_1689 = false;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_389 == null)
         {
            var_389 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_101:
               var_1168 = param1.session.isPrivateRoom;
               if(var_82 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1688 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_807)
         {
            if(!var_344.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_997.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_388 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_997 == null)
         {
            var_997 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_389.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_388.buildCatalogIndex(_loc2_);
         if(var_998 != "")
         {
            var_388.openPage(var_998);
            var_998 = "";
         }
         else
         {
            var_388.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1687 && var_470 != null)
         {
            var_470.playSound(HabboSoundTypesEnum.const_940);
         }
         var_1687 = false;
      }
