package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_901:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1442 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1442) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1219) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1394) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1299) as IWindowContainer;
         if(_loc1_ != null)
         {
            var_55.push(new SpecialInfoWidget(_loc1_));
         }
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1381) as IWindowContainer;
         if(_loc1_ != null)
         {
