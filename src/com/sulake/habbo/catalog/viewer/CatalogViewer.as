package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1489:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_443 != null)
         {
            if(var_443.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_443.window);
            var_443.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1489);
         var_443 = _loc5_;
      ...
      {
         return var_443.dispatchWidgetEvent(param1);
      }
