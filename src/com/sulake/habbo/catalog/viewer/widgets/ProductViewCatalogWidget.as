package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1346:IScrollbarWindow;
      
      protected var var_1331:XML;
      
      private var var_1345:BitmapData;
      
      private var var_1196:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1195.text = "${" + _loc3_.name + "}";
            var_1196.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1195.text = "${" + _loc2_.localizationId + "}";
            var_1196.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_447:
                  _loc4_ = var_1345.clone();
                  if(var_628 != null)
                  {
                     var_628.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_628,var_1346,var_1331);
                  }
                  break;
               case Offer.const_488:
                     ...
                     case ProductTypeEnum.const_209:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_262,AvatarAction.const_394);
                              _loc13_.appendAction(AvatarAction.const_398,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_38,true);
      ...
      {
         var_1195 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1196 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1580 = new Point(var_88.x,var_88.y);
         var_628 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1346 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_628 == null)
         {
         ...
         var_1345 = _loc2_.content as BitmapData;
