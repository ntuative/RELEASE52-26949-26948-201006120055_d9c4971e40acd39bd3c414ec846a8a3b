package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1082 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1082 != null)
         {
            var_1082.addEventListener(WindowKeyboardEvent.const_760,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1082.text));
      }
   }
}
