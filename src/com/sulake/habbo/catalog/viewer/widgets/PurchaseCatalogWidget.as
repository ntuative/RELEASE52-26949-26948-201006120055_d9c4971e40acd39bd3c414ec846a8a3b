package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2288:XML;
      
      private var var_956:IWindowContainer;
      
      private var var_2414:ITextWindow;
      
      private var var_2289:String = "";
      
      private var var_2468:IButtonWindow;
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_342:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_2288) as IWindowContainer;
               break;
            case Offer.const_420:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_2290) as IWindowContainer;
               break;
            case Offer.const_485:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_2292) as IWindowContainer;
               break;
            case Offer.const_562:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_2291) as IWindowContainer;
               break;
            default:
         ...
         var_1652 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         var_1651 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         var_1650 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         var_2414 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(var_78 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_78,page,var_2289);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            var_2288 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            var_2290 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            var_2292 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         if(_loc4_ != null)
         {
            var_2291 = _loc4_.content as XML;
         }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_1652 != null)
         {
            ...
            var_1652.caption = "${catalog.purchase.price.credits}";
         }
         if(var_1651 != null)
         {
         ...
         if(var_1650 != null)
         {
            ...
            var_1650.caption = "${catalog.purchase.price.credits+pixels}";
         }
         if(var_957 != null)
         {
            var_957.enable();
