package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_826:MarketPlaceOfferData;
      
      private const const_1445:int = 1;
      
      private const const_1709:int = 40;
      
      private var var_478:IWindowContainer;
      ...
      private const const_1708:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_478)
         {
            ...
            var_478 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_478)
         {
            return;
         ...
         updateStatusDisplay(const_1446,_loc2_.length);
         if(!var_396)
         {
            var_396 = new Timer(25);
            var_396.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_825 = 0;
         populateList();
         var_396.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_579)
         {
            return;
         }
         var _loc3_:* = [];
         ...
         for each(_loc5_ in var_579)
         {
            if(_loc5_.method_1 == param1)
            {
               _loc5_.method_1 = 0;
               _loc5_.image = param2;
            }
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_478 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_478.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1445);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_397.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_396)
         {
            var_396.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_396 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_825 >= var_579.length)
            {
               return true;
            }
            addListItem(var_579.getWithIndex(var_825));
            ++var_825;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_826.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_397));
            _loc7_.selection = 0;
         }
      }
