package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_623[var_1087] as Array;
      ...
      {
         var _loc2_:Offer = var_623[var_1087][var_2083];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_488 || _loc1_.pricingModel == Offer.const_484)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_85 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.method_2 != null)
                     {
                        _loc5_ = _loc3_.method_2.name;
                        if(var_1088.indexOf(_loc5_) == -1)
                        {
                           var_1088.push(_loc5_);
                           var_623.push(new Array());
                        }
                        _loc6_ = var_1088.indexOf(_loc5_);
                        (var_623[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_623)
         {
      ...
      {
         var _loc3_:Number = param1.productContainer.firstProduct.method_2.colourIndex;
         var _loc4_:Number = param2.productContainer.firstProduct.method_2.colourIndex;
         if(_loc3_ > _loc4_)
         {
            return 1;
         }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_623)
         {
            if(var_2083 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2083] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1087 = var_987.getGridItemIndex(param1.view);
         var _loc2_:String = "null";
         var _loc3_:Array = var_623[var_1087] as Array;
         var _loc4_:Array = new Array();
         for each(_loc5_ in _loc3_)
         {
            _loc6_ = _loc5_.productContainer.firstProduct.method_2;
