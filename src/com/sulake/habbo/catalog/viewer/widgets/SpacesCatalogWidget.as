package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1388:String = "default";
      
      private var var_1379:Array;
      
      private var var_280:BitmapData = null;
      
      private var var_239:int = 0;
      
      private var var_770:int = 0;
      
      private var var_1387:String = "1.1";
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               switch(_loc4_.method_2.name)
               {
                  ...
                  case "wallpaper":
                     ...
                     if(_loc8_)
                     {
                        var_1380.push(_loc2_);
                     }
                     else
                     {
                        Logger.log("[SpacesCatalogWidget] Could not find wallpaper pattern configuration! " + [_loc2_.localizationId,_loc4_.method_2.name]);
                     }
                     break;
                  case "landscape":
                     ...
                     if(_loc8_)
                     {
                        var_1378.push(_loc2_);
                     }
                     else
                     {
                        Logger.log("[SpacesCatalogWidget] Could not find landscape pattern configuration! " + [_loc2_.localizationId,_loc4_.method_2.name]);
                     }
                     break;
                  default:
                     Logger.log("[SpacesCatalogWidget] : " + _loc4_.method_2.name);
                     break;
               }
            }
            _loc3_ = 0;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_280 != null && var_279 != null)
         {
            setRoomImage(var_280,var_279);
         }
      }
         ...
         switch(param1)
         {
            case const_201:
               ...
               for each(_loc8_ in var_146.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_768 = _loc8_.children().length();
                  }
               }
            ...
            case const_202:
               ...
               if(var_321 >= _activeFloorPatterns.length)
               {
                  var_321 = 0;
               }
               var_278 = 0;
               ...
               for each(_loc9_ in var_146.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_769 = _loc9_.children().length();
                  }
               }
            ...
            case const_91:
               ...
               for each(_loc10_ in var_146.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_770 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1388);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1378[var_320];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1387);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1388,var_1387,64,this,"window_romantic_wide");
