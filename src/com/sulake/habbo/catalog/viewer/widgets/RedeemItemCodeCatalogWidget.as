package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1146:IButtonWindow;
      
      private var var_1145:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1146 != null)
         {
            var_1146.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1145 != null)
         {
            var_1145.removeEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1146 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1146 != null)
         {
            var_1146.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1145 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1145 != null)
         {
            var_1145.addEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
