package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_160:int = 31;
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_579.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_209)
         {
            var_209 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_209)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_209.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_209.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = var_29.purse.pastClubDays > const_160 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = var_29.purse.pastClubDays % const_160;
            _loc4_ = var_29.purse.pastClubDays / const_160;
         ...
         if(_loc6_)
         {
            _loc2_ = var_29.purse.pastVipDays > const_160 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = var_29.purse.pastVipDays % const_160;
            _loc4_ = var_29.purse.pastVipDays / const_160;
            var_29.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_29.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      {
         if(!param1 || !param2 || !var_579 || !var_29)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_579.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         {
            _loc11_ = param2.monthsRequired * const_160;
            if(param2.isVip)
            {
            ...
            {
               _loc13_ = _loc12_ % const_160;
               _loc14_ = _loc12_ / const_160;
