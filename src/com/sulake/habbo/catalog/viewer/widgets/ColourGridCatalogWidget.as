package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_305:IWindowContainer;
      
      private var var_1236:XML;
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_305 != null)
         {
            _loc2_ = var_305.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1236 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_305 = null;
         for each(_loc1_ in var_1237)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1236) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_709.width,var_709.height,true,0);
               _loc3_.bitmap.copyPixels(var_709,var_709.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_951.width,var_951.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_792.width,var_792.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_792,var_792.rect,new Point(0,0),null,null,true);
