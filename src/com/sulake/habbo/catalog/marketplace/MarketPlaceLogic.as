package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1743:int = 3;
      
      public const const_1667:int = 2;
      ...
      private var var_2210:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1514,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1867 || param1.furniTypeId != var_1871)
         {
            return;
         }
         var_2210 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1667,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_513)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1940 = _loc3_.creditsWaiting;
         var_210 = new Map();
      ...
      {
         requestOffers(var_2212,var_2209,var_2211,var_2213);
      }
