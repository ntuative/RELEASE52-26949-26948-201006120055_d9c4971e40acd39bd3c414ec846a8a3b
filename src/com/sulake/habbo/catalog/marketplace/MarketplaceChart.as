package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1148 + var_1148 / -var_2437 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_974 - var_974 / var_458 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_458).toString().length - 1);
         var_458 = Math.ceil(var_458 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_458.toString();
         _loc3_.draw(_loc6_);
         var_1148 = param1 - _loc6_.textWidth - 2;
         var_974 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_974);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_974 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1148 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1148,(param2 - var_974) / 2));
         return _loc3_;
      }
