package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1148:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1603:XML;
      
      private static var var_1605:XML;
       
      
      private var var_2405:IWindowContainer;
      ...
      private var var_1604:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1604 == 4294967295)
            {
               var_1604 = _loc1_.color;
            }
            _loc1_.color = const_1148;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1270;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1603) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_50 = navigator.catalog.windowManager.buildFromXML(var_1605) as IItemListWindow;
         if(var_50 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1309;
            }
         }
      }
