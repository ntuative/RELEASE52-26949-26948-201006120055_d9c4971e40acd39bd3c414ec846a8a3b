package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_22.tellUI(HabboHelpViewEnum.const_244,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_285,_loc6_);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_22.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + getCloseReasonKey(_loc3_.closeReason) + "}",0,method_5);
      }
      ...
      {
         var_22.showUI(HabboHelpViewEnum.const_320);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_423);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_693);
         var_22.tellUI(HabboHelpViewEnum.const_693,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_347)
            {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_601);
      }
