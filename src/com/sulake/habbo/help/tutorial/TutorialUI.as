package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_230:String = "TUI_NAME_VIEW";
      
      public static const const_89:String = "TUI_MAIN_VIEW";
      
      public static const const_349:String = "TUI_CLOTHES_VIEW";
      
      public static const const_481:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         _main.events.addEventListener(HabboHelpTutorialEvent.const_490,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_434,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_114));
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1143 = param2;
         var_1142 = param3;
         if(var_34 == null || var_34.id == const_89)
         {
            prepareForTutorial();
            showView(const_89);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_34 != null && (var_34.id == const_230 || var_34.id == const_89))
         {
            showView(const_89);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1656;
         _window.width = _loc2_.width + var_1655;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            ...
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_490,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_434,onTaskDoneEvent);
            _main = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_497:
               var_1142 = true;
               if(var_34 != null && var_34.id == const_481)
               {
                  showView(const_89);
               }
               break;
            case HabboHelpTutorialEvent.const_490:
               if(var_34 != null && var_34.id == const_349)
               {
                  var_1425 = true;
                  disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_434:
               if(var_1425)
               {
                  var_1425 = false;
                  showView(const_89);
      ...
      {
         var_1144 = true;
         if(var_34 != null && (var_34.id == const_349 || var_34.id == const_89))
         {
            showView(const_89);
         }
      }
      ...
      {
         return var_1144 && var_1143 && var_1142;
      }
   }
}
