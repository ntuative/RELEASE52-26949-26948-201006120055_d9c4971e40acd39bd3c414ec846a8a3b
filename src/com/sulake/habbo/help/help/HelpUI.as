package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1468:int = 0;
      ...
      private var var_2301:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26949-26948-201006120043");
         _toolbar = param5;
         var_110 = new Map();
         var_110.add(HabboHelpViewEnum.const_1292,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_146,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_423,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_285,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_244,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_693,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_320,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_555,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_218,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_110.add(HabboHelpViewEnum.const_930,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_601,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1655 = 0 - _loc3_.width;
         var_1656 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_287 == HabboHelpViewEnum.const_146 || false)
         {
            return;
         }
         if(var_454 == null)
      ...
      {
         return var_110.getValue(var_287);
      }
      ...
      {
         var_2300 = param1;
         var _loc2_:IHelpViewController = var_110.getValue(HabboHelpViewEnum.const_146) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_218:
               ...
               break;
            case CallForHelpResultEnum.const_958:
               showUI(HabboHelpViewEnum.const_930);
               break;
            case CallForHelpResultEnum.const_1041:
      ...
      {
         var _loc3_:* = null;
         if(var_287 == HabboHelpViewEnum.const_146)
         {
            return;
         }
         if(true)
         {
            ...
            var_652.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_652[1],var_652[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_652[0],var_652[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1656;
         _window.width = _loc1_.width + var_1655;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_287);
            return;
         }
         ...
         if(_loc3_)
         {
            if(_toolbar != null)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_497));
      }
