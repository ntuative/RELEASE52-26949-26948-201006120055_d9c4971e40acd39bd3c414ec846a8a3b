package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_678:FaqCategory;
      
      private var var_677:FaqCategory;
      ...
      {
         super();
         var_677 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_678 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_124 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_677.hasItem(param1))
         {
            var_677.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_678.hasItem(param1))
         {
            var_678.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
