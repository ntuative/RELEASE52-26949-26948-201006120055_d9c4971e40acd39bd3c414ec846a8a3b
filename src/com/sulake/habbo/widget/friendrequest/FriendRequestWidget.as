package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_729,param1));
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_469,eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_467,eventHandler);
      }
      ...
      private function eventHandler(param1:RoomWidgetFriendRequestUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFriendRequestUpdateEvent.const_469:
               var_249.add(param1.requestId,new FriendRequestDialog(this,param1.requestId,param1.userId,param1.userName));
               break;
            case RoomWidgetFriendRequestUpdateEvent.const_467:
      ...
      private function removeRequest(param1:int) : void
      {
         ...
         var _loc2_:FriendRequestDialog = var_249.getValue(param1) as FriendRequestDialog;
         if(!_loc2_)
         {
            return;
         }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_469,eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_467,eventHandler);
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_701,param1));
         removeRequest(param1);
      }
   }
}
