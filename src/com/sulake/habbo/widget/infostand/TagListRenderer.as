package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1711:int = 5;
      
      private const const_1712:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1260 != null && var_1260.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_115);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_857 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_857 += param1.height + const_1712;
            return fit(param1);
         }
         param1.offset(_offsetX,var_857);
         _offsetX += param1.width + const_1711;
         return true;
      }
