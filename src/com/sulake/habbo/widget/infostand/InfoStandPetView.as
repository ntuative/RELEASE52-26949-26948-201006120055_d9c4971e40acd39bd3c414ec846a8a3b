package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1733:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1732:String = "level";
      
      private var var_106:IItemListWindow;
      
      private const const_1725:String = "energy";
      
      private var var_1276:Map;
      
      private const const_1728:String = "nutrition";
      
      private var var_64:IItemListWindow;
      
      private const const_1726:uint = 3355443;
      
      private var var_238:IBorderWindow;
      ...
      private const const_1730:uint = 11184810;
      
      private const const_1729:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_238 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_238 != null)
         {
            var_106 = var_238.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_238.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_238.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_106 == null || var_238 == null || var_64 == null)
         {
            return;
         }
         ...
         var_238.height = NaN;
         _window.width = Math.max(var_238.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1276.getValue(var_647) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1732,param1.level,param1.levelMax);
         updateStateElement(const_1729,param1.experience,param1.experienceMax);
         updateStateElement(const_1725,param1.energy,param1.energyMax);
         updateStateElement(const_1728,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_647 = param1.id;
         var_1276.remove(param1.id);
         var_1276.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_181 && var_181.getPetId() == var_647)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_444,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1731,const_1727,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1730);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1726);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1733);
         return _loc5_;
      }
