package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_163[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_163[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_163)
         {
            _loc6_ = var_163[_loc3_];
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         var_163["rooms_icon"] = ["gohome_white","gohome_color"];
         var_163["dance_icon"] = ["dance_white","dance_color"];
         var_163["clothes_icon"] = ["clothes_white","clothes_color"];
         var_163["effects_icon"] = ["effects_white","effects_color"];
         var_163["badges_icon"] = ["badges_white","badges_color"];
         var_163["wave_icon"] = ["wave_white","wave_color"];
         var_163["hc_icon"] = ["_white","_color"];
         var_163["settings_icon"] = ["settings_white","settings_color"];
         var_163["credits_icon"] = ["credits_white","credits_color"];
         var_163["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1030));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_612);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1006));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_261);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_826));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_763);
               break;
            case "news":
               if(false && false)
               {
