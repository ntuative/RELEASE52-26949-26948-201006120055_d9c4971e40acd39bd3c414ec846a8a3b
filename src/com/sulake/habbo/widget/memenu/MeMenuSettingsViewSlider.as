package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_941:MeMenuSettingsView;
      
      private var var_2449:int;
      
      private var var_590:BitmapData;
      
      private var var_1041:Number = 1.0;
      ...
      {
         if(param1.type != WindowEvent.const_480)
         {
            return;
         }
         var_941.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return param1 / var_1505 * (var_1041 - var_708) + var_708;
      }
   }
}
