   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_870 = _window.findChildByName("effect_hilite");
            var_870.visible = false;
         }
         var_871 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_872 = _window.findChildByName("loader_bar");
         if(var_872 != null)
         {
            var_451 = var_872.width;
            var_179.start();
            onUpdate();
         }
         if(false)
