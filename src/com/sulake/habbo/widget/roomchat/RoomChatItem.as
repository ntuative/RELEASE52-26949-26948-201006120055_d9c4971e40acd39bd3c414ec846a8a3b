package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_523:int = 6;
      
      private static const const_371:int = 10;
      
      private static const const_1136:Number = 18;
      
      private static const const_1456:Number = 10;
      
      private static const const_1457:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1075,var_1073,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1075,var_742,var_1073,_roomId,_roomCategory,param1);
      }
      ...
      public function method_6(param1:RoomWidgetChatUpdateEvent) : void
      {
         var_1314 = param1.chatType;
         var_1075 = param1.userId;
         var_742 = param1.userName;
         var_1073 = param1.userCategory;
         _message = param1.text;
         var_1316 = param1.userX;
         var_203 = param1.userImage;
         var_1074 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_55,onBubbleMouseDown);
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1074 != 0)
            {
               _loc30_ = uint(var_1074 >> 16 & 255);
               _loc31_ = uint(var_1074 >> 8 & 255);
               _loc32_ = uint(var_1074 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_371;
            }
            else
            {
               _loc19_.text = var_742 + ":";
               _loc19_.y += var_429;
               _loc19_.width = _loc19_.textWidth + const_371;
               _width += _loc19_.textWidth + const_371;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1314 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_742);
            }
            else if(var_1314 == RoomWidgetChatUpdateEvent.const_288)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_742);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_429;
            _loc20_.width = _loc20_.textWidth + const_523;
            _width += _loc20_.textWidth + const_523;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_371 + _loc20_.textWidth + const_523;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1075,var_1073,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1075,var_1073,_roomId,_roomCategory,param1);
      }
