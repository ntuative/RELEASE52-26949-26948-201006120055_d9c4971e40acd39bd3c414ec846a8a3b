package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_796[var_1137] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_324)
         {
            ...
            var_324 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_324.center();
            var_324.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1137;
         if(var_1137 < var_796.length)
         {
            _loc1_ = var_796[var_1137] as Dictionary;
            if(!_loc1_)
            {
