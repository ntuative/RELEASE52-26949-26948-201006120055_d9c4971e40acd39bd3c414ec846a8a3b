package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_705:Array = null;
      ...
      private var var_999:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_121,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_120,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_329,update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1696;
         if(_loc2_ > var_1214)
         {
            vote();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_121,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_120,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_329,update);
      }
