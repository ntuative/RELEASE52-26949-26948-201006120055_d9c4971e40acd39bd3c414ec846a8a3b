package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1443:int = 5;
      
      private static const const_523:int = 16;
      
      private static const const_1059:int = 20;
      
      private static const const_371:int = 10;
      
      private static const const_1058:int = 40;
      ...
      private var var_451:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_996 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1679 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1680 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_673 = new Timer(1000,1);
         var_673.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_806 = new Timer(5000,1);
         var_806.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window.addEventListener(WindowEvent.const_480,onWindowMoved);
         var_1167 = true;
         var_123 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1681 = _loc2_.width + const_523 + _loc6_.width + const_1059;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1058,_loc8_.width) + const_523);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_996 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_123 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_451);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_451);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_55,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_469);
