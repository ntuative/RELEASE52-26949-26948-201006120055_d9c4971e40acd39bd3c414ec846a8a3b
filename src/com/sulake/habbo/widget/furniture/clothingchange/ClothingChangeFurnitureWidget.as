package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_818:String = "Girl";
      
      private static const const_817:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_361,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_906,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_361:
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_2092 = param1.objectCategory;
         ...
         _window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_59,HabboWindowStyle.const_41,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_361,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_906,onUpdate);
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_104,true);
         var_651 = _loc4_;
         var_651.offset(100,100);
         var _loc6_:IWindow = var_651.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_340,param1,var_165,var_2092,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_651 != null)
         {
            _loc1_ = var_651 as IFrameWindow;
            if(_loc1_ != null)
            {
