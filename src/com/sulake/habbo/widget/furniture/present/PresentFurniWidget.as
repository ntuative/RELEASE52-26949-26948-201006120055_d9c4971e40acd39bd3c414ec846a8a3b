package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1065:Number = 100;
       
      
      private var var_247:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_65,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_86,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_440,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_504,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_134,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_65,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_65,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_86,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_440,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_504,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_65,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_392:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_504:
               if(!var_247)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_440:
               if(!var_247)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_691,var_165);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1064,const_1065,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_215 != null)
         {
            _loc4_.caption = var_215;
         }
