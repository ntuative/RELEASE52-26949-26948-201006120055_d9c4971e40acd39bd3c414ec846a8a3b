package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_170:HabboHotelView;
      ...
      private var var_1712:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1457:ILogger;
      
      private var var_1184:String;
      
      private var var_1714:String;
      
      private const const_1444:String = "fuselogin";
      
      private var var_328:ICoreCommunicationManager;
      
      private var var_392:IKeyExchange;
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         if(var_1001)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_171);
         }
         var_1713 = true;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1713)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_682 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_682);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_189);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1184,var_1714));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1444,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_392.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_392.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1712);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1444,"/");
      ...
      {
         var_682 = _habboConfiguration.getKey("sso.ticket",null);
         var_1184 = _habboConfiguration.getKey("flash.client.url","");
         var_1714 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_170 == null)
         {
            var_170 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_682 != null)
         {
            var_58.mode = HabboConnectionType.const_499;
            var_58.initConnection(HabboConnectionType.const_293);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1457 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1712 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_58.mode)
         {
            case HabboConnectionType.const_499:
               _loc6_ = "";
               ...
               var_1002 = _loc4_;
               var_170.loadBannerImage(_loc7_ + "?token=" + var_1002,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_959:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1330:
               var_570 = generateRandomHexString(30);
               var_392 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_392.init(var_570);
               _loc8_ = var_392.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_170.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1002);
         ...
         var_392 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_392.init(_loc14_);
            _loc15_ = var_392.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_58.mode = HabboConnectionType.const_959;
            }
         }
         var_58.initConnection(HabboConnectionType.const_293);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_242);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_116,onRoomSessionEnded);
      }
