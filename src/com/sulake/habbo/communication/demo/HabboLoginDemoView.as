package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_583:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_173.shockwaveClientUrl = var_116.shockwaveClientUrl;
         var_173.ssoTicket = var_116.ticket;
         var_116.removeEventListener(SSOTicket.const_360,onParsedTicketSuccess);
         var_116.removeEventListener(SSOTicket.const_255,onParsedTicketFailure);
         var_116 = null;
         dispatchEvent(new Event(const_583));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1444,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_173.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_115,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1444,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_116 = new SSOTicket(var_173.assets,_loc2_,_loc1_);
         var_116.addEventListener(SSOTicket.const_360,onParsedTicketSuccess);
         var_116.addEventListener(SSOTicket.const_255,onParsedTicketFailure);
      }
