package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1139:String = "bus_oviopen_hidden";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1137:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_502,0,_loc4_,_loc5_);
                     break;
                  case const_1138:
                  case const_1139:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_385,0,_loc4_,_loc5_);
               }
         }
