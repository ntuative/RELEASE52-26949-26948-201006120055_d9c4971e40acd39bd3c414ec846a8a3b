package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1635:int = 1500;
      
      private var var_1634:int = 255;
      
      private var var_1633:int = 255;
      
      private var var_1409:uint = 16777215;
      
      private var var_1132:uint = 16777215;
      
      protected var var_87:RoomPlaneParser = null;
      
      private var var_944:int = 0;
      
      private var var_1383:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_984,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_638,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_677,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_738,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_625,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_846,int(param1.bgOnly));
         var_1409 = _color;
         var_1634 = var_1383;
         var_1132 = _loc3_;
         var_1633 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_838:
               param2.setNumber(RoomObjectVariableEnum.const_677,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_955:
               param2.setNumber(RoomObjectVariableEnum.const_738,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_625,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_510:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_208)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_744:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_904,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_586:
               param2.setString(RoomObjectVariableEnum.const_545,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_732:
               param2.setString(RoomObjectVariableEnum.const_584,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_734:
               param2.setString(RoomObjectVariableEnum.const_541,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_944)
         {
            ...
            {
               _loc7_ = var_1409 >> 16 & 255;
               _loc8_ = var_1409 >> 8 & 255;
               _loc9_ = var_1409 & 255;
               _loc10_ = var_1132 >> 16 & 255;
               _loc11_ = var_1132 >> 8 & 255;
               _loc12_ = var_1132 & 255;
               _loc13_ = (_loc2_ - var_944) / var_1635;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1634 + (var_1633 - var_1634) * _loc13_;
               _color = _loc3_;
               var_1383 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_638,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_87.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_111,0);
            }
            return;
         }
         _loc5_--;
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1295,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1182,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_111,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_183)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_156 || _loc13_ == RoomPlaneData.const_289)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
