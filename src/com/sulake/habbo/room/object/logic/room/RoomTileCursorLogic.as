package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomTileCursorLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setNumber(RoomObjectVariableEnum.const_233,1);
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc2_.type == RoomObjectVisibilityUpdateMessage.const_505)
            {
               if(_loc3_ != null)
               {
            ...
            else if(_loc2_.type == RoomObjectVisibilityUpdateMessage.const_406)
            {
               if(_loc3_ != null)
               {
