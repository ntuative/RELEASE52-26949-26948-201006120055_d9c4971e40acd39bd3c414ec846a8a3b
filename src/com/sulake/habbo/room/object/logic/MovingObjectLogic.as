package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_899:int = 500;
       
      
      private var var_73:Vector3d;
      
      private var var_2450:Vector3d;
      
      private var var_1864:int = 0;
      
      private var var_1044:int = 500;
      ...
      override public function update(param1:int) : void
      {
         ...
         if(var_1045 != null)
         {
            _loc2_ = param1 - var_1865;
            if(_loc2_ > var_1044)
            {
               _loc2_ = var_1044;
            }
            _loc3_ = Vector3d.product(var_1045,_loc2_ / Number(var_1044));
