package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1525:int = 16777216;
      
      public static const const_1635:int = 1;
       
      
      private var var_2436:int = 69069;
      
      private var var_1364:int = 1;
      
      private var var_2435:int = 5;
      
      private var var_1615:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1615 * param2);
      }
      ...
      {
         var _loc1_:int = var_2436 * var_1364 + var_2435;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
