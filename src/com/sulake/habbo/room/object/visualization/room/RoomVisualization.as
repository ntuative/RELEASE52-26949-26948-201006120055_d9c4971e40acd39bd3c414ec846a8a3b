package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_795:int = 16777215;
      
      public static const const_1266:int = 10066329;
      
      private static const const_796:int = 13421772;
      
      public static const const_1382:int = 16777215;
      
      public static const const_1327:int = 16777215;
      
      private static const const_798:int = 10066329;
      
      private static const const_797:int = 10066329;
      ...
      private var var_627:Rectangle = null;
      
      private var var_2102:int = 255;
      
      private var var_2105:Boolean = false;
      
      private var var_2103:int = 255;
      ...
      private var var_1725:Number = 0.0;
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_87.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_289)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_984);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_912);
         var _loc7_:int = 0;
         while(_loc7_ < var_87.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_289)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1371)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_109,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_904);
            if(_loc3_ != var_2106)
            {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_638));
            if(_loc4_ != var_1095)
            {
               var_1095 = _loc4_;
               var_2103 = var_1095 & 255;
               var_2102 = var_1095 >> 8 & 255;
               var_2104 = var_1095 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_846));
            if(_loc5_ != var_1579)
            {
               var_1579 = _loc5_;
               _loc2_ = true;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_627 == null)
         {
            var_627 = super.boundingRectangle;
         }
         return new Rectangle(var_627.x,var_627.y,var_627.width,var_627.height);
      }
         ...
         while(_loc8_ < var_435.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < var_107.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_109 || _loc3_.type == RoomPlane.const_91)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_109 || _loc3_.type == RoomPlane.const_91 && _loc12_ == RoomPlaneBitmapMaskData.const_208)
                              {
               ...
               if(_loc11_ != null)
               {
                  if(_loc11_.update(param1,_loc5_))
                  {
                     if(_loc11_.visible)
                     {
                        ...
                        if(_loc11_.type != RoomPlane.const_202)
                        {
      ...
      {
         if(param1 != var_311["null"] || param2 != var_311["null"] || param3 != var_311["null"])
         {
            var_311["null"] = param1;
            var_311["null"] = param2;
            var_311["null"] = param3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc7_ < var_1864 + const_1724 && !_loc4_ && !_loc6_)
         {
            return;
         }
         ...
         while(_loc8_ < var_206.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_91)
            {
               if(var_1579)
               {
                  ...
                  _loc13_ = uint((_loc12_ & 255) * var_2103 / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * var_2102 / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * var_2104 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_202 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:Boolean = false;
         if(param1.updateId != var_1189)
         {
            var_1189 = param1.updateId;
            var_627 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != var_1005 || _loc3_.y != var_1726 || _loc3_.z != var_1725 || param1.scale != var_1727))
            {
               var_1005 = _loc3_.x;
               var_1726 = _loc3_.y;
               var_1725 = _loc3_.z;
               var_1727 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : void
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_584);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_545);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_541);
            updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_677));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_738));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_625));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + var_1578;
      }
