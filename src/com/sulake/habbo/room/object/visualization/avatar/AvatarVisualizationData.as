package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public function getAvatar(param1:String, param2:Number, param3:String = null) : IAvatarImage
      {
         var _loc4_:* = null;
         if(_avatarRenderer != null)
         {
            ...
            if(param2 > 48)
            {
               _loc4_ = _avatarRenderer.createAvatarImage(param1,AvatarScaleType.const_56,param3);
            }
            else
            {
               _loc4_ = _avatarRenderer.createAvatarImage(param1,AvatarScaleType.SMALL,param3);
            }
            return _loc4_;
         }
         return null;
