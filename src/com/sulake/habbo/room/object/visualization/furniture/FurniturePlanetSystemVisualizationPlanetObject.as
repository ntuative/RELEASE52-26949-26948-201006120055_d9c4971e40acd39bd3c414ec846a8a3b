package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1156:Number = 30;
      ...
      {
         var_765 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1301 = param3;
         var_2185 = param4 * 0 * 2 / 360;
         var_1616 = param5 * 0 * 2 / 360;
         _height = param6;
         var_923 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1301 * Math.cos(var_923 + var_1616);
         var _loc4_:Number = var_1301 * Math.sin(var_923 + var_1616);
         var _loc5_:Number = _height;
         var_765.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_765.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_765.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_765.add(param1);
         }
