   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1729)
         {
            if(!param1)
            {
               var_255.assign(var_573);
               var_256.assign(var_572);
            }
            else
            {
               var_255.assign(var_573);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_73 == null && var_814 != null || var_255 == null || var_256 == null || var_472 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1189)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1005 || _loc4_.y != var_1726 || _loc4_.z != var_1725 || param1.scale != var_1727))
            {
               var_1005 = _loc4_.x;
               var_1726 = _loc4_.y;
               var_1725 = _loc4_.z;
