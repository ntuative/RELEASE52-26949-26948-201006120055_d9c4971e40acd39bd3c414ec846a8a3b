package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1438:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2358:int = -1;
      ...
      protected var var_1647:String = null;
      ...
      private var var_2085:Number = 0.0;
      ...
      protected var var_2359:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_625[param1] = _loc3_;
            var_624[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1647 != null && var_1647.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2358,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2086 != param1 || var_2085 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_625[_loc3_] = "";
               var_624[_loc3_] = false;
               _loc3_--;
            }
            var_2086 = param1;
            var_2085 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2087 != param1 || var_2088 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2358 = _loc3_.getNumber(RoomObjectVariableEnum.const_216);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_233));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1647 = _loc3_.getString(RoomObjectVariableEnum.const_335);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_290 != _loc3_.getUpdateID() || param1 != var_149 || param2 != var_2359)
         {
