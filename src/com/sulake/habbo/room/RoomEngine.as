package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_300:String = "object_icon_sprite";
      
      private static const const_806:int = -3;
      
      private static const const_808:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1154:String = "tile_cursor";
      
      private static const const_301:int = -1;
       
      
      private var var_395:IRoomObjectVisualizationFactory = null;
      ...
      private var var_640:NumberBank;
      ...
      private var var_763:RoomMessageHandler = null;
      
      private var var_762:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_316 = new Map();
         var_640 = new NumberBank(1000);
         var_1109 = new Map();
         var_317 = new Map();
         var_68 = new RoomObjectEventHandler(this);
         var_763 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_68 != null)
         {
            ...
            {
               return var_68.deleteWallItem(var_120,var_119,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_687) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_610) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_656) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_695) + 0.5;
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_68.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_68 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_68.modifyWallItemData(var_120,var_119,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_395 != null)
         {
            var_395.release(new IIDRoomObjectVisualizationFactory());
            var_395 = null;
         }
         if(var_42 != null)
         {
         ...
         if(var_762 != null)
         {
            var_762.release(new IIDRoomRendererFactory());
            var_762 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_762.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_918;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_626);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_667);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_702);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_873);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1013);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1009) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_996);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_510,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_744,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_549,var_120,var_119,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_68 != null)
         {
            return var_68.modifyRoomObject(var_120,var_119,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_586,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_732,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_42 != null)
         {
            ...
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_40);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_281);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_68 != null)
         {
            var_68.handleRoomObjectEvent(param1,var_120,var_119);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_344;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_335,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_919,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_893,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_287,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_650,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_27 == null || var_395 == null || var_42 == null || var_762 == null || _communication == null || _habboConfiguration == null || !var_2160)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_301,RoomObjectCategoryEnum.const_70);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1356,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_42.getRoom(getRoomIdentifier(var_120,var_119));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_806,RoomObjectCategoryEnum.const_281);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1359);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_300);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1359);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_300);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_395 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_395;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_238,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_432,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_378,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_167,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_668,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_138,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_143,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_103,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_135,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_471,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_479,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_387,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_414,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_448,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_388,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_494,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_462,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_64,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_446,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_507,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_298,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_456,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_304,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_321,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_502,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_994,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_385,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_435,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_68 != null)
         {
            return var_68.initializeRoomObjectInsert(var_120,var_119,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_532 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_581,0,0));
            _loc2_ = 0;
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.targetCategory = RoomObjectCategoryEnum.const_40;
         }
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_287,param1,param2,param3,RoomObjectCategoryEnum.const_40));
         }
         return true;
      }
      ...
      {
         disposeObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_40);
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_955,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_838,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_509);
                     break;
                  case RoomObjectCategoryEnum.const_40:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_194);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_323);
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_335,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_918,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_287,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_273.events.addEventListener(AdEvent.const_405,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_808) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_68 != null)
         {
            var_68.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_68 != null)
         {
            return var_68.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_560,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_762 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      
      private function getObjectUser(param1:int, param2:int, param3:int) : IRoomObjectController
      {
         return getObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_40);
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_532 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_42.getRoom(const_525);
         if(_loc10_ == null)
         {
            _loc10_ = var_42.createRoom(const_525,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_640.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_509,param8);
               break;
            case RoomObjectCategoryEnum.const_40:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_194,param2);
               break;
            case RoomObjectCategoryEnum.const_70:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_183,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_156,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_156,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_289,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_545,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_584,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_541,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_510,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1109.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1015,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_640.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_807,RoomObjectCategoryEnum.const_281);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_300);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1611 - _loc12_.width / 2;
               _loc11_.y = var_1610 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_437,var_120,var_119,-1,RoomObjectCategoryEnum.const_219));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_68 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_301,const_526);
                  var_68.handleRoomObjectEvent(_loc14_,var_120,var_119);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         else if(var_12 != null)
         {
            ...
            if(param2 == RoomObjectCategoryEnum.const_40)
            {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1359);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_300);
            _loc11_ = addOverlayIconSprite(_loc10_,const_300,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1611 - _loc6_.data.width / 2;
               _loc11_.y = var_1610 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_322,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_965,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_961,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_827,RoomObjectVariableEnum.const_322,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_751,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_68 != null)
         {
            var_68.cancelRoomObjectInsert(var_120,var_119);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_42.getRoom(const_525);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc4_:* = null;
         var _loc5_:* = 0;
         var _loc6_:int = var_12.method_3(param1);
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1015);
               ...
               var_640.freeNumber(_loc10_ - 1);
               _loc13_ = var_1109.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_120,var_119,const_301,RoomObjectCategoryEnum.const_70,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_301,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_840,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_967,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_301,const_526,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_538,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_626,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_687,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_656,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_610,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_695,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_912,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_586,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_732,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_510,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_208);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_667,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_702,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_667,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_702,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_873,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1013,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_807,const_1154,RoomObjectCategoryEnum.const_281);
         _loc7_.createRoomObject(const_806,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_281);
         return _loc7_;
      }
