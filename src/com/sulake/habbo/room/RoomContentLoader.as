package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_805:String = "selection_arrow";
      
      private static const const_803:String = "tile_cursor";
      
      private static const const_299:String = "RCL_PUBLICROOM_";
      
      private static const const_524:String = "wall_place_holder";
      
      private static const const_1151:int = 2;
      
      private static const const_372:String = "place_holder";
      
      private static const const_1150:String = const_372;
      
      private static const const_1464:int = 0;
      ...
      private var var_1108:IEventDispatcher = null;
      
      private var var_1357:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_530 = [];
         _wallItems = [];
         var_2157 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2153 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_324,_loc4_);
      ...
      {
         var _loc2_:String = var_529.getValue(param1) as String;
         return getObjectColorIndex(_loc2_);
      }
      
      public function hasInternalContent(param1:String) : Boolean
      {
         if(param1 == RoomObjectVisualizationEnum.const_151 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_440 != null)
         {
            _loc2_ = var_440.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_344.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_180 != null && var_180.hasWorldType(const_299 + param1))
         {
            return var_180.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_364 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_364.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_637.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_372,const_524,ROOM_CONTENT,const_803,const_805];
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:int = method_3(param1);
         if(_loc2_ == RoomObjectCategoryEnum.const_34 || _loc2_ == RoomObjectCategoryEnum.const_32)
         {
            ...
            return int(var_531.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2157.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_180 != null && (var_180.type == param1 || var_180.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1150;
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_168 && _loc5_ != RoomObjectLogicEnum.const_151)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_636.getValue(param1) != null)
         {
            return var_636.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2153.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1357.add(_loc5_,_loc8_);
               var_180 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_324,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_433,_loc5_);
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_441 != null)
         {
            _loc2_ = var_441.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1311);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_529.getValue(param1) as String;
      ...
      public function method_3(param1:String) : int
      {
         if(param1 == null)
         {
      ...
      private function continueInitilization() : void
      {
         if(var_2155)
         {
            ...
            if(var_1108 != null)
            {
               var_1108.dispatchEvent(new Event(const_751));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_180 != null)
         {
            return var_180.method_10(const_299 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_636.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_528.add(_loc3_,_loc4_);
               if(var_530.indexOf(_loc7_) < 0)
               {
                  var_530.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               var_529.add(_loc3_,_loc4_);
               if(_wallItems.indexOf(_loc7_) < 0)
               {
                  _wallItems.push(_loc7_);
               }
            }
            _loc8_ = var_531.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_531.remove(_loc7_);
               var_531.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1108 = param1;
         var_2158 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_2154 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_2156 = param2.getKey("public.room.dynamic.download.url","");
         var_2159 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_37 = const_804;
         initFurniData();
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_364.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_441 != null)
         {
            var_441.remove(param1);
            var_441.add(param1,param2);
         }
         if(var_440 != null)
         {
            var_440.remove(param2);
            var_440.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_168 && _loc5_ != RoomObjectVisualizationEnum.const_151)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_395.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_364.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(method_3(const_299 + param1) == RoomObjectCategoryEnum.const_70)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1357.getValue(param1) != null)
         {
            var_180 = var_1357.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_443,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_180 != null)
         {
            return var_180.getWorldScale(const_299 + param1);
         }
         return 32;
      }
   }
