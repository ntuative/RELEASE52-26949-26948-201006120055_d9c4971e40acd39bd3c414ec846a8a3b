package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1164:uint = 1;
      ...
      private var var_1414:IEventDispatcher;
      
      private var var_2464:uint = 0;
      
      private var var_1415:ProfilerAgentTask;
      
      private var var_1413:ProfilerOutput;
      
      private var var_789:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1414 = Component(param1).events;
         var_448 = new Array();
      ...
      {
         return var_244[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_244[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_789 = new WindowRenderer(var_783);
         var_244 = new Array(const_374);
         var _loc5_:int = 0;
         while(_loc5_ < const_374)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_789,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_244[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_219 = var_244[const_1164];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_219.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_219.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1300,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_244[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_244.pop()).dispose();
            }
            var_244 = null;
            while(false)
            {
      ...
      {
         return var_244[param1].getDesktopWindow().getChildAt(var_219.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_448[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_448[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1413 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1413 = new ProfilerOutput(_loc3_,this,var_789);
               var_1412 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1412);
               var_1415 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1415);
               var_1134 = true;
            }
         }
      }
      ...
      {
         return var_219.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_980.length > 0)
         {
            var_1414.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_374 - 1;
            while(_loc2_ >= 0)
            {
               var_244[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1134)
         ...
         var_1414.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_374)
         {
            var_244[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1134)
         {
         ...
         if(WindowContext.var_980.length > 0)
         {
            WindowContext.var_980.flush();
         }
         if(WindowContext.var_1432.length > 0)
         {
            WindowContext.var_1432.flush();
         }
         var_1414.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_219.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1355,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1428,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1181,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1255,param2.name + ": " + param2.toString());
            }
         }
      }
   }
