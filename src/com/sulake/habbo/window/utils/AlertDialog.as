package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1104:String = "_alert_button_list";
      
      private static const const_786:String = "_alert_button_cancel";
      
      private static const const_587:String = "_alert_button_ok";
      
      private static const const_1190:String = "_alert_text_summary";
      
      private static var var_672:uint = 0;
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = _window.findChildByName(const_1104) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(_window)
         {
            ITextWindow(_window.findChildByTag("DESCRIPTION")).text = var_1395;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  if(var_189 != null)
                  {
                     var_189(this,new WindowEvent(WindowEvent.const_187,null,null));
                  }
                  break;
               case "header_button_close":
                  if(var_189 != null)
                  {
                     var_189(this,new WindowEvent(WindowEvent.const_743,null,null));
                  }
            }
         }
      }
