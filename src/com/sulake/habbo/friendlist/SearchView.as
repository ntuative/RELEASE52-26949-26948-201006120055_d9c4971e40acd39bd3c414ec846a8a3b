package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_716 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_716.procedure = onSearchInput;
         var_716.addEventListener(WindowKeyboardEvent.const_150,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_362.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_362.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_50.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_336,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onAskForFriendButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:Boolean = this._friendList.method_9(_loc3_.avatarId,_loc3_.avatarName);
         if(!_loc4_)
         {
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_716.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
