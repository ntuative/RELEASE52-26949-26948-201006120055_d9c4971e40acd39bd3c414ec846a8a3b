package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_353:int = 100;
      ...
      {
         return Math.ceil(this.var_243.length / const_353);
      }
      ...
      {
         if(this.var_947 >= this.getPageCount())
         {
            this.var_947 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         while(_loc3_ < var_243.length)
         {
            ...
            {
               var_243.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_947 + 1) * const_353,this.var_243.length);
      }
