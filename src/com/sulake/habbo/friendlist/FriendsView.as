package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_680:String = "bg";
       
      
      private var var_1978:IContainerButtonWindow;
      
      private var var_1976:IContainerButtonWindow;
      
      private var var_1979:IContainerButtonWindow;
      
      private var var_1977:IContainerButtonWindow;
      
      private var var_362:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_362 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1976 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1979 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1978 = initButton("room_invite",onInviteButtonClick,param1);
         var_1977 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_680);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_362.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_362.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_33)
         {
            this.var_362.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_284)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_284 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1976,isEnableMinimailButton(_loc1_));
         setEnabled(var_1979,isEnableHomeButton(_loc1_));
         setEnabled(var_1978,isEnableInviteButton(_loc1_));
         setEnabled(var_1977,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_680);
