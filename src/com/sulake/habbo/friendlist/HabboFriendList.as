package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1619:OpenedToWebPopup;
      
      private var var_914:IAvatarRenderManager;
      ...
      private var var_1620:AvatarSearchResults;
      ...
      private var var_2217:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_937:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2217 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_93 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1620 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_366.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_366.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_394.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_366 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_93.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_93.addCategory(new FriendCategory(FriendCategory.const_946,getText("friendlist.friends")));
         var_93.addCategory(new FriendCategory(FriendCategory.const_460,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_537)
         {
            var_537 = new Timer(120000);
            var_537.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_537.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_537.stop();
            var_537.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_537 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_914)
         {
            var_914.release(new IIDAvatarRenderManager());
            var_914 = null;
         }
         if(var_937)
         {
            var_937.release(new IIDHabboNotifications());
            var_937 = null;
         }
         if(_toolbar)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_315));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1620.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_195,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_366.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function method_9(param1:int, param2:String) : Boolean
      {
         if(_view == null)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_646.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_646.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_366.limit)
         {
            var_366.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_394.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_914.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_46);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_366.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_394.findTab(FriendListTab.const_87);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1619 == null)
         {
            var_1619 = new OpenedToWebPopup(this);
         }
         var_1619.show(x,y);
      }
