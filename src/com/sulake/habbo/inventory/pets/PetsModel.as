package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_147 && false)
         {
      ...
      {
         var_29.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1299 && param1.type == RoomEngineObjectEvent.const_231)
         {
            var_29.showView();
            var_1299 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1299 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_40,RoomObjectTypeEnum.const_356,_loc3_.figure);
            var_29.closeView();
            return;
         }
