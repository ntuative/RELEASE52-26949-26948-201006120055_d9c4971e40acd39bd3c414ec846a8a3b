package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      private var var_305:PetsGridItem;
      ...
      private var var_509:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_509 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_598 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_598.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_305 != null)
         {
            var_305.setSelected(false);
         }
         var_305 = param1;
         if(var_305 != null)
         {
            var_305.setSelected(true);
         }
         ...
         if(param1.type == WindowEvent.const_62)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  _model.switchCategory(FurniModel.const_47);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_305.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_598.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_509.removeGridItem(_loc2_.window);
         if(var_305 == _loc2_)
         {
            var_305 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_598.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_509.addGridItem(_loc2_.window);
            var_598.add(param1.id,_loc2_);
            if(var_305 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_56,this);
            if(_loc13_ == null)
            {
               return;
            }
