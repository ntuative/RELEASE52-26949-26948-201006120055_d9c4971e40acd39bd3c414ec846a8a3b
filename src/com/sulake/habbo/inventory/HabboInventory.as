package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_976:IRoomSession;
      ...
      private const const_1739:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_49.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_49.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionEvent.const_116,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_389,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_49.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_116:
               var_976 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_389:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_49.getValue(InventoryCategory.const_544));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_49.getValue(InventoryCategory.const_79));
      }
      ...
      {
         return PetsModel(var_49.getValue(InventoryCategory.const_147));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1027));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_49.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_49.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1739);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_49.getValue(InventoryCategory.const_332));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_49.length)
         {
            _loc3_ = var_49.getWithIndex(_loc2_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_975.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_975.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < var_49.length)
         {
            _loc2_ = var_49.getWithIndex(_loc1_) as IInventoryModel;
      ...
      {
         return TradingModel(var_49.getValue(InventorySubCategory.const_297));
      }
      ...
      {
         return var_49.getValue(InventoryCategory.const_305) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_49.getValue(InventoryCategory.const_276));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_116,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_389,roomSessionEventHandler);
         ...
         var_49.add(InventoryCategory.const_305,_loc3_);
         ...
         var_49.add(InventoryCategory.const_147,_loc10_);
