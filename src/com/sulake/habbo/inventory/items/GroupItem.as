package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1713:int = 13421772;
      ...
      protected var var_2361:BitmapData;
      ...
      protected var var_464:int = 0;
      
      protected var var_1441:String;
      
      private const const_1714:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_385:BitmapData;
      
      private const const_1471:Number = 0.2;
      
      protected var var_1445:Boolean;
      
      private const const_1472:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_755)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1622));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1441);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1471;
               _loc1_.blend = const_1471;
            }
            else
            {
               _window.blend = const_1472;
               _loc1_.blend = const_1472;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1445 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2361;
               _loc5_.visible = true;
            }
            else
            {
