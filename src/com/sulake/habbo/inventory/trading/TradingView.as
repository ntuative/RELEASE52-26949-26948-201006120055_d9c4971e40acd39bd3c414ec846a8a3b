package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_802:uint = 4284532064;
      
      private static const const_801:uint = 2577770;
      
      public static const const_1021:int = 0;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_192)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_953)
            {
            ...
            var_362.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_455);
            var_362.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1588 == null)
         {
            var_1588 = createMinimizedWindow();
         }
         if(!var_2115)
         {
            return var_65;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_65)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_802) : uint(const_801);
            }
