package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1418:uint = 9;
      
      public static const const_239:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_503 = false;
         var_731 = false;
         var_48.updateItemList(var_730);
         var_48.updateItemList(var_1294);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_48.alertPopup(TradingView.const_869);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_730)
            {
               var_503 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_731 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_730)
            {
               var_48.alertPopup(TradingView.const_933);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_37 + " NEW STATE: " + param1 + " OWN: " + var_503 + " OTHER: " + var_731);
         ...
         {
            case const_188:
               if(param1 == const_170 || param1 == const_239)
               {
                  var_37 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_607)
         {
            if(var_37 != const_188 && var_37 != const_239)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_188;
            var_11.toggleInventorySubPage(InventorySubCategory.const_832);
            var_607 = false;
         }
         var_48.setMinimized(false);
      }
