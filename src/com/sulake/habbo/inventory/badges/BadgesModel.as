package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1710:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_835.length)
         {
            if(var_835[_loc2_] == param1)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_260[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_260.length)
               {
                  if((var_260[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_260[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
