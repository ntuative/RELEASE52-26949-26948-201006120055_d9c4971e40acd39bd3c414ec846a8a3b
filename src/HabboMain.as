package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private var var_1165:HabboTracking;
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc14_:Number = 1 - const_26 + var_28.getNumberOfFilesLoaded() / _loc13_ * const_26;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      private function prepareCore() : void
      {
         ...
         var_1165 = HabboTracking.getInstance();
         ...
         else
         {
            ...
            _loc1_.addEventListener(AssetLoaderEvent.const_50,configLoadedHandler);
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_50,configLoadedHandler);
         ...
         if(var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               if(_loc4_.fileName == "hh_human_fx.swf" || _loc4_.fileName == "hh_human_body.swf")
               {
                  if(var_1165 && true)
                  {
                     var_1165.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_928,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_29);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_928,error);
            Core.dispose();
         }
      }
